...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_created=None, base_path=None, base_url=None, name=None, pulp_href=None, content_guard=None, hidden=False, pulp_labels=None, local_vars_configuration=None):  # noqa: E501
