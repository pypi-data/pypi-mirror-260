...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, name=None, pulp_created=None, content_guard=None, pulp_labels=None, base_path=None, hidden=False, base_url=None, local_vars_configuration=None):  # noqa: E501
