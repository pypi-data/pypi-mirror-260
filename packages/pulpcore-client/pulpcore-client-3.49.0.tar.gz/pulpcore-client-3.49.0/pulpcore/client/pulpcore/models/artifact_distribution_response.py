...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_labels=None, content_guard=None, hidden=False, pulp_created=None, base_url=None, name=None, base_path=None, pulp_href=None, pulp_last_updated=None, local_vars_configuration=None):  # noqa: E501
