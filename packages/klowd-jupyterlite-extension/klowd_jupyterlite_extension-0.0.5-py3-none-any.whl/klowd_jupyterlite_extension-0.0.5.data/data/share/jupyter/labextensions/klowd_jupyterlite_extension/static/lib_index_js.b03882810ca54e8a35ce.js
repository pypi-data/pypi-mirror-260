...
const copyShareableLinkId = 'klowd_jupyterlite_extension:share-link';
/**
    ...
    activate: (app, settingRegistry, themeManager, factory) => {
        ...
        window.addEventListener('message', event => {
            if (event.data.type === 'switch theme') {
                ...
                themeManager.setTheme(themeManager.theme === 'JupyterLab Dark'
                    ? 'JupyterLab Light'
                    : 'JupyterLab Dark');
            }
        });
...
//# sourceMappingURL=lib_index_js.b03882810ca54e8a35ce.js.map