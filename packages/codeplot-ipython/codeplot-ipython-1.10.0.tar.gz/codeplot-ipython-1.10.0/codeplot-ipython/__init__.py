...
class Magics(Magics):
    ...
    def cP_supress_output(self, boolean):
        ...
        _cP_extension._supress_output = True if boolean.lower() == 'true' else False
        
        if _cP_extension._supress_output:
            _cP_extension.ipython.display_formatter.formatters = {}
        else:
            _cP_extension.ipython.display_formatter.formatters = _cP_extension._original_display_formatters
...
class IPythonExtension:
    def __init__(self, ipython):
        ...
        self._original_display_formatters = self.ipython.display_formatter.formatters
        ipython.display_pub.publish = self.custom_display_pub_publish
    ...
    def post_run_cell(self, result):
        ...
        # Actually lets clear all outputs
        ...
        if self._supress_output is True and self.connection_established is True:
            self.ipython.display_pub.clear_output(wait=True)
