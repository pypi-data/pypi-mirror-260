...
function GetOciCommandsToLongParams_opsi() {
    $ociCommandsToLongParams = @{
        ...
        'opsi host-insights update-pe-comanaged-host' = 'defined-tags force freeform-tags from-json help host-insight-id if-match max-wait-seconds wait-for-state wait-interval-seconds'
...
function GetOciCommandsToShortParams_opsi() {
    $ociCommandsToShortParams = @{
        ...
        'opsi host-insights update-pe-comanaged-host' = '? h'
