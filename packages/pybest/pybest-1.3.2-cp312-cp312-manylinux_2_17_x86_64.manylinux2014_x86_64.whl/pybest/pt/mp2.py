...
class RMP2(Perturbation):
    ...
    @timer.with_section("UpdatingAuxMatMP2")
    ...
    @timer.with_section("MP2Relaxation")
    def compute_1dm_relaxation(self, dmout, amplitudes):
        ...
        **Arguments:**
        ...
        l_abij.contract(
            "abcd->badc", out=Aaibj, factor=-2.0, clear=True, select="einsum"
        )
        l_aijb.contract("abcd->acdb", out=Aaibj, factor=-2.0, select="einsum")
