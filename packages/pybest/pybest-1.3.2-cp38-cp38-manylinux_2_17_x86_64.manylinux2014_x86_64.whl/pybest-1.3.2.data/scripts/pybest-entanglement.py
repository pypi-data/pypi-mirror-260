...
def ploti12(
    ...
    **Arguments:**
    ...
    for i in range(len(indices)):
        ...
        #
        filename = f"mo_{str(indices[i])}.png"
        try:
            offset = 50
            if i % 2 == 0:
                offset = 70
...
def main():
    """This is main() of CLI app, the flow is following: the data and command
    ...
    if plot_type in ["i", "all"]:
        ...
        i_12 = zip(i12_index_1, i12_index_2, i12_value)
        i_12 = [(i, j, v) for i, j, v in i_12 if i in indices and j in indices]
