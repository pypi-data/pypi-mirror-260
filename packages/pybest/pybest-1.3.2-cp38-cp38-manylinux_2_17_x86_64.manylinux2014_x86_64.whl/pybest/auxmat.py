...
from pybest.linalg import DenseLinalgFactory, OneIndex, TwoIndex
from pybest.linalg.base import LinalgFactory
...
def get_fock_matrix(lf, mo1, mo2, nocc, ncore=0):
    ...
    **Arguments:**
    ...
    if isinstance(lf, LinalgFactory):
        ...
        fock = lf
        tmplf = DenseLinalgFactory(fock.nbasis)
        # temp storage
        tmp = tmplf.create_three_index()
    else:
...
@timer.with_section("DiagFockmatrix")
