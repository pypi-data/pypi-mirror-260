...
class PBQuasiNewton:
    ...
    def __init__(self, lf, maxiter=200, ethreshold=1e-6, tthreshold=1e-6):
        """
        ** Arguments **
    ...
    def compute_energy(obj, tk):
        ...
        ** Returns **
        ...
        """
        e = obj.calculate_energy(obj.e_ref, **obj.unravel(tk.copy()))
        return e
    ...
    def __call__(self, obj, guess, *args, **kwargs):
        ...
        while iter_ < self.maxiter:
            ...
            #
            try:
                obj.callback_t(diis.tk[-1].array, diis.dtk[-1].array)
            except TypeError:
                obj.callback_t(diis.tk[-1], diis.dtk[-1])
            #
            # Check if converged
            #
