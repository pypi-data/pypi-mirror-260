...
class RXIPCC(ABC):
    ...
    def print_results(self, **kwargs):
        ...
        **Keyword arguments:**
        ...
        for ind, e_ip in enumerate(e_vals):
            ...
            log(
                f"Energy of ionized state:    {e_ip_tot: 4.8f} [au]  /  "
    ...
    @staticmethod
    def sort_ci_vector(e_vec_j, threshold):
    ...
    def transform_integrals(self, one_ao, two_ao, mos, **kwargs):
    ...
    def build_guess_vectors(self, nguess, to_disk, *args):
        """
    ...
    def __call__(self, *args, **kwargs):
         ...
         * spin-dependent hole operator
         * spin-dependent hole-particle-hole operator
