...
from pybest.orbital_utils import rotate_orbitals, transform_integrals
from pybest.utils import fda_2order, numpy_seed
...
def test_pccd_hessian():
    ...
    def fun(x):
        ...
        kin = geminal_solver.from_cache("t")
