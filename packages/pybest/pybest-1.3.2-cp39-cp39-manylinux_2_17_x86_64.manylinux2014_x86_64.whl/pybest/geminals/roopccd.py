...
from pybest.geminals.oogeminals import OOGeminals
from pybest.geminals.rpccd_base import RpCCDBase
from pybest.log import log


class ROOpCCD(RpCCDBase, OOGeminals):
    """Restricted orbital-optimzied pCCD wavefunction class"""

    acronym = "ROOpCCD"
    long_name = "Restricted orbital optimised pair Coupled Cluster Doubles"
    reference = ""
    cluster_operator = "T_p"
    comment = "restricted, orbital optimized"
