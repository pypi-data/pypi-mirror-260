...
from pybest.gbasis.gobasis import compute_ppcp, get_charges, get_gobasis
...
def test_ppcp():
    ...
    obasis = get_gobasis("cc-pvdz", coord_file, print_basis=False)
    pc_file = context.get_fn("test/water_pc.pc")
    charges = get_charges(pc_file)

    ppcp = compute_ppcp(obasis, charges)
