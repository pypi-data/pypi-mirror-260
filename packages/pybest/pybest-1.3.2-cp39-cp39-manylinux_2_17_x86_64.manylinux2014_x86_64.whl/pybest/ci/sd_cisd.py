...
class SDRCISD(SD):
    ...
    def compute_h_diag(self, *args):
        ...
        **Returns:**
        ...
        hdiag.assign(
            hdiag_s.array[1:], begin0=1, end0=2 * rci.nactv * rci.nacto + 1
        )
        hdiag.assign(hdiag_d.array[1:], begin0=2 * rci.nactv * rci.nacto + 1)
        return hdiag
    ...
    def h_diag_singles(self):
        ...
        rci = self.object
        self.dimension = "CIS"
        hdiag = rci.lf.create_one_index(2 * self.dimension - 1)
    ...
    def build_subspace_hamiltonian(self, bvector, hamiltonian, *args):
        ...
        **Arguments:**
        ...
        # Bvectors
        #
        b_sa = rci.lf.create_two_index(nacto, nactv)
    ...
    def build_subspace_hamiltonian_singles(self, bvector, hamiltonian):
        ...
        **Arguments:**
        ...
        rci = self.object
        self.dimension = "CIS"
        sigma = rci.lf.create_one_index(2 * self.dimension - 1)
    ...
    def build_subspace_hamiltonian_doubles(self, bvector, hamiltonian, *args):
        ...
        **Arguments:**
        ...
        b_d.assign(bvector.array[2 * rci.nacto * rci.nactv + 1 :], begin0=1)
