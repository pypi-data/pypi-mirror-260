...
class pCCDPT2D(pCCDPT2):
    ...
    @timer.with_section("PT2DAmplitudes")
...
class pCCDPT2O(pCCDPT2):
    ...
    def amplitudes2index(self, t):
        ...
        # add missing block
        tp_ = td.contract("abab->ab", clear=True, select="einsum")
    ...
    def vfunction(self, amplitudes, *args):
        ...
        **Arguments:**
        ...
        tp_ = ptamplitudes.contract("abab->ab", clear=True, select="einsum")
        ...
        if self.singles:
            ...
            #
            fock.contract(
                "ab,cd->abcd", samplitudes, out, **ov, select="einsum"
            )
