...
class RpCCDCISD(SpinFree):
    ...
    def compute_h_diag(self, *args):
        ...
        **Returns:**
        ...
        hdiag.assign(
            hdiag_s.array[1:], begin0=1, end0=self.nactv * self.nacto + 1
        )
        hdiag.assign(hdiag_d.array[1:], begin0=self.nactv * self.nacto + 1)
        return hdiag
    ...
    def build_subspace_hamiltonian(self, bvector, hamiltonian, *args):
        ...
        sigma_d.iadd_expand_three_to_four("abc->abcb", tmp_iaj)
        #
        # delta_ij
        ...
        sigma_d.iadd_expand_three_to_four("abc->abac", tmp_iab)
    ...
    def build_subspace_hamiltonian_doubles(self, bvector, hamiltonian, *args):
        ...
        **Arguments:**
        ...
        b_d.assign(bvector.array[self.nacto * self.nactv + 1 :], begin0=1)
