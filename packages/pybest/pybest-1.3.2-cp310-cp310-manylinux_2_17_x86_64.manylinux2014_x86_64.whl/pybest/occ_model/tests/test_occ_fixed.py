...
test_fixed = [
    ...
    (
        "cc-pvdz",
        "test/water.xyz",
        {"occ_a": np.array([1, 1, 1, 1, 1]), "nel": 10},
        {
            "occ": [[1, 1, 1, 1, 1]],
            "charge": 0,
            "nel": 10,
    ...
    (
        "cc-pvdz",
        "test/water.xyz",
        {"occ_a": np.array([1, 1, 1, 1, 0, 1]), "nel": 10},
        {
            "occ": [[1, 1, 1, 1, 0, 1]],
            "charge": 0,
            "nel": 10,
...
@pytest.mark.parametrize("basis,mol,kwargs,expected", test_fixed)
...
def test_occ_fixed(
    ...
    """Test Fixed AufBau model for gobasis, nocc_a/nocc_b, and ncore arguments as
    input."""
    ...
    factory_instance = gobasis if factory is Basis else lf
...
def test_occ_fixed_arguments_gobasis(
    kwargs: Any, error: Any, factory: Union[Basis, DenseLinalgFactory]
):
    """Test Fixed occupation model for gobasis, nocc_a/nocc_b,
