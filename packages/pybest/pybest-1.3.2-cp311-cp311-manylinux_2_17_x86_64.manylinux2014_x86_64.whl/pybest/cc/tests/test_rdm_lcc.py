...
rdm_set = [
    # LCCD
    ("H2O", "pCCDLCCD", 5, 24, "dm_1", "pq", ("t_2",), ("l_2",), ("t_p",)),
    ("H2O", "pCCDLCCD", 5, 24, "dm_2", "pPPp", ("t_2",), ("l_2",), ("t_p",)),
    ("H2O", "pCCDLCCD", 5, 24, "dm_2", "pqqp_a", ("t_2",), ("l_2",), ("t_p",)),
    ("H2O", "pCCDLCCD", 5, 24, "dm_2", "pQQp_b", ("t_2",), ("l_2",), ("t_p",)),
    ("H2O", "pCCDLCCD", 5, 24, "dm_2", "qQQp", ("t_2",), ("l_2",), ("t_p",)),
    ("H2O", "pCCDLCCD", 5, 24, "dm_2", "pQPp", ("t_2",), ("l_2",), ("t_p",)),
    ("H2O", "pCCDLCCD", 5, 24, "dm_2", "qQPq", ("t_2",), ("l_2",), ("t_p",)),
    ("H2O", "pCCDLCCD", 5, 24, "dm_2", "qQPp", ("t_2",), ("l_2",), ("t_p",)),
    ("H2O", "pCCDLCCD", 5, 24, "dm_2", "pQPq", ("t_2",), ("l_2",), ("t_p",)),
    ("H2O", "pCCDLCCD", 5, 24, "dm_2", "qPPp", ("t_2",), ("l_2",), ("t_p",)),
    ("H2O", "pCCDLCCD", 5, 24, "dm_3", "qPQQPp", ("t_2",), ("l_2",), ("t_p",)),
    ("H2O", "pCCDLCCD", 5, 24, "dm_3", "qpPPpq", ("t_2",), ("l_2",), ("t_p",)),
    (
        "H2O",
        "pCCDLCCD",
        5,
...
@pytest.mark.parametrize(
    "mol,method,occ,nbasis,rdm,block,t_cc,l_cc,t_p", rdm_set
)
def test_rdm_lcc(mol, method, occ, nbasis, rdm, block, t_cc, l_cc, t_p):
