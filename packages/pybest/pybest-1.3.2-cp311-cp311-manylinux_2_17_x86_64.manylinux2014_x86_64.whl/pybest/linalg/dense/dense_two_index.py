...
import numpy as np
from scipy.linalg import eig, eigh, eigvals, eigvalsh, inv, sqrtm
...
class DenseTwoIndex(TwoIndex):
    ...
    def assign_dot(self, other, tf2):
        ...
        **Arguments:**
        ...
        """
        check_type("other", other, DenseOrbital)
    ...
    def iadd(
        ...
        **Optional arguments:**
        ...
        if isinstance(other, DenseTwoIndex):
            ...
            if transpose:
                self.array[begin0:end0, begin1:end1] += (
                    other.array[begin2:end2, begin3:end3]
                ).T * factor
            else:
                self.array[begin0:end0, begin1:end1] += (
    ...
    def iadd_diagonal(self, other, factor=1.0, begin0=0, end0=None):
        ...
        **Optional arguments:**
        ...
        """
        check_type("factor", factor, float, int)
        check_type("other", other, DenseOneIndex, float)
        end1 = None
        end0, end1 = self.fix_ends(end0, end1)
    ...
    def divide(
        ...
        **Optional arguments:**
        ...
        """
        end0, end1 = self.fix_ends(end0, end1)
        check_type("other", other, DenseTwoIndex, DenseOneIndex)
        check_type("factor", factor, float, int)
        if out is None:
    ...
    def iadd_expand_one_to_two(
        ...
        """Expand one-index object along one axes and add it to two-index
        object.
        ...
        **Optional arguments:**
        ...
        """
        check_options("axis", axis, "a->ab", "b->ab")
        end0 = one.fix_ends(end0)[0]
        aend0, aend1 = self.fix_ends(aend0, aend1)
        if axis == "a->ab":
            for i in range(abegin1, aend1):
                self.array[:, i] += one.array[begin0:end0] * factor
        if axis == "b->ab":
    ...
    def idot(self, other, transpose=False):
        ...
        **Arguments:**
        ...
        other
             The other array.
        """
        check_type("other", other, DenseTwoIndex, DenseOrbital)
        if isinstance(other, DenseTwoIndex):
            if transpose:
    ...
    def imul(
        ...
        **Optional arguments:**
        ...
        begin0, end0, begin1, end1
             ...
             not given, the full range is used.
        """
        check_type("other", other, DenseOneIndex, DenseTwoIndex)
        check_type("factor", factor, float, int)
        if isinstance(other, DenseTwoIndex):
            end2, end3 = other.fix_ends(end2, end3)
