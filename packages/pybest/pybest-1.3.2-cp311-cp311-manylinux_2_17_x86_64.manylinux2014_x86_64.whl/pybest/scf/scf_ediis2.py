...
from pybest.scf.scf_cdiis import CDIISHistory
from pybest.scf.scf_diis import DIISHistory, DIISSCFSolver
from pybest.scf.scf_ediis import EDIISHistory
...
class EDIIS2History(EDIISHistory, CDIISHistory):
    ...
    def solve(self, dms_output, focks_output):
        ...
        if errmax > 1e-1:
            ...
            energy1, coeffs1, cn1, method1, error = CDIISHistory.solve(
                self, None, None
            )
            energy2, coeffs2, cn2, method2, error = EDIISHistory.solve(
                self, None, None
            )
