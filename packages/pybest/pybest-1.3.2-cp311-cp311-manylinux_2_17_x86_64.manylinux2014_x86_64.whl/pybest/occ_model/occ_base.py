...
all child classes:
    ...
    * gobasis (an instance of GOBasis or LinalgFactory)
...
from pybest.exceptions import ArgumentError, ElectronCountError
...
class OccupationModel(abc.ABC):
    ...
    1) Using a GOBasis instance. Here, nel is deduced from the electronic
    ...
    def __init__(self, factory: Union[Basis, LinalgFactory], **kwargs) -> None:
        """
        **Arguments:**

        factory:
            A GOBasis instance (e.g., for molecules) or a LinalgFactory instance
        ...
        **Keyword arguments:**
        ...
        """
        check_type("gobasis/lf", factory, Basis, LinalgFactory)
        ...
        #
        # Distinguish between GOBasis and LF instances
        #
    ...
    @property
    def factory(self):
        """A GOBasis or LinalgFactory instance depending on the chosen
        Hamiltonian"""
    ...
    def from_hdf5(cls, grp):
        ...
        **Arguments:**
        ...
        """
        gobasis = cls._gobasis_from_hdf5(grp)
        kwargs = cls._attrs_from_hdf5(grp)
        result = cls(gobasis, **kwargs)
        return result
    ...
    def _gobasis_from_hdf5(grp):
        """Get proper GOBasis/LF instance from stored file.
        ...
        **Arguments:**
        ...
        if lf == "DenseLinalgFactory":
            return DenseLinalgFactory.from_hdf5(grp)
        if lf == "CholeskyLinalgFactory":
            return CholeskyLinalgFactory.from_hdf5(grp)
        raise ArgumentError(f"Unkown lf class {lf}")
