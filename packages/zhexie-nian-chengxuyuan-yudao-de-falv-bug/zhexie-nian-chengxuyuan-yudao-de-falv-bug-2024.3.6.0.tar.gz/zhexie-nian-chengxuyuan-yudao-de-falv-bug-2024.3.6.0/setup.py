...
setuptools.setup(
    name="zhexie-nian-chengxuyuan-yudao-de-falv-bug",
    version=ZhexieNianChengxuyuanYudaoDeFalvBug.__version__,
    url="https://github.com/apachecn/zhexie-nian-chengxuyuan-yudao-de-falv-bug",
    ...
    entry_points={
        'console_scripts': [
            "zhexie-nian-chengxuyuan-yudao-de-falv-bug=ZhexieNianChengxuyuanYudaoDeFalvBug.__main__:main",
