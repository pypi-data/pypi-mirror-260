...
from resemble.aio.errors import Aborted, SystemAborted
...
class Stub:
    ...
    async def _call(
        ...
        *,
        ...
        aborted_type: Optional[type[Aborted]] = None,
        ...
        try:
            ...
            if status is not None:
                if aborted_type is not None:
                    # TODO: https://github.com/reboot-dev/respect/issues/2418
                    aborted = aborted_type.from_status(  # type: ignore[attr-defined]
                        status
                    )
                    if aborted is not None:
                        raise aborted from None

                aborted = SystemAborted.from_status(status)
                if aborted is not None:
                    raise aborted from None
