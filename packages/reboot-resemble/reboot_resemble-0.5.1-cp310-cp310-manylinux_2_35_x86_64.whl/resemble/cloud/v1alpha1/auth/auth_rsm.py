    ...
    async def write(
        ...
        async with self._middleware._state_manager.transactionally(
            ...
            async with self._middleware._state_manager.writer(
                ...
                effects: APIKeyServicer.Effects = await f(
                    writer_context, state
                )

                assert_type(effects, [APIKeyServicer.Effects])
...
resemble.cloud.v1alpha1.auth.auth_pb2.InvalidInputError]
    ...
    async def Authenticate(
        ...
        *,
        ...
        return await self.reader(context).Authenticate(
            request,
            metadata=rsm_metadata,
        )
