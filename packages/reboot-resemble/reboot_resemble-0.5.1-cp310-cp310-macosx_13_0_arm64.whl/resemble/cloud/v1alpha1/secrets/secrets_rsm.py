        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.reader(
                ...
                if transaction is not None:
                    ...
                    # TODO: See https://github.com/reboot-dev/respect/issues/2340
                    await self._state_manager.transaction_participant_store(  # type: ignore[attr-defined]
                        transaction
                    )
                return response
    ...
    async def write(
        ...
        async with self._middleware._state_manager.transactionally(
            ...
            async with self._middleware._state_manager.writer(
                ...
                effects: SecretServicer.Effects = await f(
                    writer_context, state
                )

                assert_type(effects, [SecretServicer.Effects])
...
class Secret:
    ...
    class ReadAborted(Aborted):

        Error = Union[
resemble.cloud.v1alpha1.secrets.secrets_pb2.NotFoundError]
...
resemble.cloud.v1alpha1.secrets.secrets_pb2.NotFoundError]
        ...
        def is_declared_error(cls, message: google.protobuf.message.Message) -> bool:
            if message.DESCRIPTOR.full_name == 'resemble.cloud.v1alpha1.secrets.NotFoundError':
                return True
            return False
    ...
    async def Read(
        ...
        return await self.reader(context).Read(
            request,
            metadata=rsm_metadata,
        )
