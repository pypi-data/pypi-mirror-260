...
def select_dataset(dataloader_type="worldstrat_preprocessed_RGBNIR",train_batch_size=2,val_batch_size=2,num_workers=2,revisits=1,prefetch_factor=2,**kwargs):
    """
    ...
    assert dataloader_type in ["worldstrat_preprocessed","NAIP",
                               ...
                               "s2_dataset","worldstrat_MISR_fake",
                               "worldstrat_r","S2NAIP","S2NAIP_int",
                               "sen2_test","S2NAIP_v2","S2NAIP_v2_MISR",
                               "S2NAIP_v2_20m","S2NAIP_v4","worldstrat_MISR"]
    ...
    if dataloader_type == "sen2_test":
        ...
        test_loader = torch.utils.data.DataLoader(ds_test,batch_size=1,num_workers=0,
                                                   shuffle=True,drop_last=True,prefetch_factor=None)
        return(test_loader)
