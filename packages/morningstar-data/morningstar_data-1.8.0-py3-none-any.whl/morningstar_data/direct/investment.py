...
from ._data_objects import DataPoints, DataPointsType, Investments, InvestmentType
from ._data_type import DryRunResults
from ._investment._asset_flow_data import AssetFlowProvider
from ._investment._common import _get_data_point_col_names, _get_data_points
...
def _get_investment_data(
    ...
    data_points: DataPointsType,
    time_series_format: TimeSeriesFormat,
    display_name: bool = False,
    dry_run: Optional[bool] = False,
) -> Union[DataFrame, DryRunResults]:
