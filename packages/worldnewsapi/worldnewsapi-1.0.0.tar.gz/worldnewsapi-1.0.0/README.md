...
```sh
pip install git+https://github.com/ddsky/world-news-api-clients/tree/main/python/.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/ddsky/world-news-api-clients/tree/main/python/.git`)
