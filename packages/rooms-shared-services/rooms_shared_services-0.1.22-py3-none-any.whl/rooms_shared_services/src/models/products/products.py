...
class StoreVariantRelatedValues(BaseModel):
    default: str | int | datetime


class GeoRelatedValues(BaseModel):
    default: StoreVariantRelatedValues
    israel: StoreVariantRelatedValues
    uk: StoreVariantRelatedValues


class LanguageRelatedValues(BaseModel):
    default: GeoRelatedValues
    hebrew: GeoRelatedValues
    english: GeoRelatedValues
    russian: GeoRelatedValues
