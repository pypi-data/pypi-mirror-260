...
class Nomad_SDK:
	...
	OUTPUT_TYPE (list): The type of the live output profile.
	...
	OUTPUT_TYPE (str | None): The type of the live output profile. The types are Archive, LiveVodHls,
	...
	LIVE_OUTPUT_TYPE (list | None): The type of the live output profile group.
	dict format: {"description": "string", "id": "string"}
