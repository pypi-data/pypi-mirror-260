...
from nomad_media_pip.admin.live_output.get_live_output_types import _get_live_output_types
...
class Nomad_SDK:
	...
	def create_live_output(self, NAME: str, OUTPUT_TYPE: str, ENABLED: bool | None,
		...
		try:
			...
			LIVE_OUTPUT_INFO = _create_live_output(self.token, self.config["serviceApiUrl"], 
	...
	def get_live_output(self, LIVE_OUTPUT_ID: str) -> dict:
		try:
			...
			LIVE_OUTPUT_INFO = _get_live_output(self.token, self.config["serviceApiUrl"], 
	...
	def get_live_outputs(self) -> list[dict]:
		try:
			...
			LIVE_OUTPUT_INFO = _get_live_outputs(self.token, self.config["serviceApiUrl"], 
				self.debug_mode)
	...
	def update_live_output(self, LIVE_OUTPUT_ID: str, NAME: str | None, OUTPUT_TYPE: str | None,
		...
		try:
			...
			LIVE_OUTPUT_INFO = _update_live_output(self.token, self.config["serviceApiUrl"], 
