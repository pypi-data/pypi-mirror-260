        ...
        def work(self, is_byte = False):
                ...
                if not is_byte:
                        if self.path_icocur.lower().endswith('.ico') or self.path_icocur.lower().endswith('.cur'):
                                with builtins.open(self.path_icocur, 'rb') as file:
...
class Encode(object):
        ...
        def load(self, path_image):
                ...
                if 'icc_profile' in image.info:
                        ...
                        with builtins.open(icc, 'wb') as iccfile:
        ...
        def ico_palette_gpl(self, file):
                ...
                palette = []
                with builtins.open(file, 'r') as fd:
        ...
        def printsave(self, how, header, data, hotspot):
                ...
                # save.
                with builtins.open(self.path_icocur, 'wb') as f_ico:
                        f_ico.write(header)
                        f_ico.write(data)
