...
def getHFModelAndTokenizer(model_name: str, cache_dir: Optional[str] = None, hf_access_token: Optional[str] = None):
    """
...
class HFAutoModelWrapper:
    ...
    def _memory_update(self, df: pandas.DataFrame):
        self.override_memories = df

    def inspect_latest_memories(self, *columns: str):
