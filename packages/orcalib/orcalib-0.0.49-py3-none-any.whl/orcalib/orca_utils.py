...
def find_suffixes_in_sequence(S, M, S_min, S_max):
    """
...
def extract_occurance_ranks(occurrences, ref_length):
...
def bag_of_words_scores(bag_of_words: list[tuple[list[int], float]], vocab_size: int):
