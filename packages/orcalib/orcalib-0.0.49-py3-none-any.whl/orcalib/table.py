...
class TableHandle:
    ...
    def update(self, data: RowDict, filter: OrcaExpr, api_version: str | None = None):
    ...
    def delete(self, filter: OrcaExpr):
        OrcaClient.delete(self.db_name, self.table_name, filter.as_serializable())

    def add_column(self, **columns: OrcaTypeHandle):
    ...
    def drop_column(self, column_names: list[str]):
