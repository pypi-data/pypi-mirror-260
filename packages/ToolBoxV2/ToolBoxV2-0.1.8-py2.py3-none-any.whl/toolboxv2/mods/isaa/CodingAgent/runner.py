...
if __name__ == "__main__":
    ...
    isaa: Tools = app.get_mod('isaa')
    # logger: Logger = get_logger()
    request_1 = """First I have a demon (python script) which is always running in the background. now I want to create a class which should imitate this demon, i.e. when I start the class on my system for the first time, a domain should open which has all the values and attributes of this class. if i now call this class a second time in a different program, i should not get the class but an interface to the class. all calls to the class and intarcitons are made via the demonen satat but are native to me."""
