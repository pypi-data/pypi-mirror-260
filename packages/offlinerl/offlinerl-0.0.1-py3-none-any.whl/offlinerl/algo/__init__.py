...
from offlinerl.config.algo import  edac_config, mcq_config, cql_config, plas_config, mopo_config, moose_config, bcqd_config, bcq_config, bc_config, crr_config, combo_config, bremen_config, maple_config, mobile_config, rambo_config, _rambo_config, td3bc_config
from offlinerl.utils.config import parse_config
from offlinerl.algo.modelfree import cql, plas, bcqd, bcq, bc, crr, edac, mcq, td3bc
from offlinerl.algo.modelbase import mopo, moose, combo, bremen, maple, mobile, rambo, _rambo
...
algo_dict = {
    ...
    '_rambo': {'algo':_rambo , 'config':_rambo_config},
