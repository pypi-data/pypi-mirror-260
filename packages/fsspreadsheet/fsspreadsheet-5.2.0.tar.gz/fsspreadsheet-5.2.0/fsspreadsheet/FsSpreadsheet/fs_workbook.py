...
class FsWorkbook(IDisposable):
    ...
    def RemoveWorksheet(self, name: str) -> None:
        self_1: FsWorkbook = self
        def _arrow56(__unit: None=None) -> FsWorksheet:
            try: 
                def _arrow55(ws: FsWorksheet) -> bool:
                    return ws.Name == name

                return default_arg(try_find_1(_arrow55, self_1._worksheets), None)
        ...
        ignore(remove_in_place(_arrow56(), self_1._worksheets, ObjectExpr57()))
