...
def _expr74(gen0: TypeInfo) -> TypeInfo:
...
OptionalSource_1_reflection = _expr74
...
def _expr75(gen0: TypeInfo) -> TypeInfo:
...
RequiredSource_1_reflection = _expr75
...
def _expr76(gen0: TypeInfo) -> TypeInfo:
...
ExpressionSource_1_reflection = _expr76
