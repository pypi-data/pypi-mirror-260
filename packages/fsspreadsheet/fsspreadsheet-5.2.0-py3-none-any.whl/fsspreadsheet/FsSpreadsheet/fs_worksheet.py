...
class FsWorksheet:
    ...
    def Columns(self, __unit: None=None) -> IEnumerable_1[FsColumn]:
        ...
        def mapping(tupled_arg: tuple[int, IEnumerable_1[FsCell]]) -> FsColumn:
            ...
            def _arrow62(__unit: None=None, tupled_arg: Any=tupled_arg) -> FsRangeAddress:
                ...
                cells_1: IEnumerable_1[FsCell] = sort_by(projection_1, tupled_arg[1], ObjectExpr59())
                ...
                tupled_arg_1 = (FsAddress__ctor_Z37302880(_arrow60(), column_index), FsAddress__ctor_Z37302880(_arrow61(), column_index))
                return FsRangeAddress__ctor_7E77A4A0(tupled_arg_1[0], tupled_arg_1[1])

            return FsColumn(_arrow62(), self_1.CellCollection)
        ...
        return map(mapping, group_by(projection, FsCellsCollection__GetCells(self_1._cells), ObjectExpr64()))

    def Copy(self, __unit: None=None) -> FsWorksheet:
        self_1: FsWorksheet = self
        fcc: FsCellsCollection = FsCellsCollection__Copy(self_1.CellCollection)
        def _arrow65(__unit: None=None) -> Array[FsRow]:
            n: Array[FsRow] = []
        ...
        def _arrow66(__unit: None=None) -> Array[FsTable]:
            n_1: Array[FsTable] = []
        ...
        return FsWorksheet(self_1.Name, _arrow65(), _arrow66(), fcc)
    ...
    def RemoveRowAt(self, row_index: int) -> None:
        ...
        with get_enumerator(filter(predicate, self_1._rows)) as enumerator:
            while enumerator.System_Collections_IEnumerator_MoveNext():
                ...
                ignore(remove_in_place(enumerator.System_Collections_Generic_IEnumerator_1_get_Current(), self_1._rows, ObjectExpr67()))
    ...
    def SortRows(self, __unit: None=None) -> None:
        ...
        sorted: Array[FsRow] = list(sort_by(projection, self_1._rows, ObjectExpr68()))
        clear(self_1._rows)
    ...
    def GetMaxRowIndex(self, __unit: None=None) -> FsRow:
        ...
        return max_by(projection, self_1.Rows, ObjectExpr69())
    ...
    def RescanRows(self, __unit: None=None) -> None:
        ...
        rows: Any = of_seq(map(mapping, self_1._rows), ObjectExpr70())
        ...
        class ObjectExpr72:
            @property
            def Equals(self) -> Callable[[int, int], bool]:
                def _arrow71(x_1: int, y_1: int) -> bool:
                    return x_1 == y_1
        ...
        iterate(action_1, group_by(projection, FsCellsCollection__GetCells(self_1._cells), ObjectExpr72()))
...
FsWorksheet_reflection = _expr73
