...
def download_models(
    ...
    lgbm_model_url = "https://syncandshare.lrz.de/dl/fiMSWXFeRgsSkQjyCnrihe/lgbm_model.tar.xz"
    barlow_twins_model_url = "https://syncandshare.lrz.de/dl/fi6VRKYnSkmLwJuZ7aT6e7/best_model.tar.xz"
