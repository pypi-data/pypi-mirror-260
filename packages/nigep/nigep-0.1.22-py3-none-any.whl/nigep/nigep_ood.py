...
class NigepOOD:
    ...
    def __init__(self, **kwargs):
        ...
        self.ood_x_data: list[any] = kwargs['ood_x_data']
        self.ood_y_data: list[any] = kwargs['ood_y_data']
    ...
    def __out_of_distribution_evaluation(self, results_folder, train_noise):
