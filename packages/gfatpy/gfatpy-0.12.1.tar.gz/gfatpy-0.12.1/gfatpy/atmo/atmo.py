...
def number_concentration_from_meteo(
    ...
    temperature: float or array
       Temperature in K
    atmospheric_component: str
         The atmospheric component to calculate the number density for. Options are: 'nitrogen', 'oxigen', 'argon', 'neon', 'helium', 'kripton', 'hydrogen', 'xenon', 'CO2', 'CH4', 'NO2', 'total'

    Returns
    -------
        (np.ndarray) : Number density of the atmosphere [molecules/m-3]
    """
