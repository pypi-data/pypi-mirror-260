...
@attrs.frozen(order=True)
class TimeWindowSeriesSpec:
    # time_windows represent the list of relative time windows
    time_windows: List[RelativeTimeWindowSpec]
    ...
    def from_data_proto(cls, proto: TimeWindowSeries) -> "TimeWindowSeriesSpec":
        ...
        for time_window in proto.time_windows:
            time_window_specs.append(RelativeTimeWindowSpec.from_data_proto(time_window))
