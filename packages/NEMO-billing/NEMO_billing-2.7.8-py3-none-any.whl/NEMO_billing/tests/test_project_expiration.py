...
class RateTimeTestCase(TestCase):
	...
	def setUpTestData(cls):
		...
		cls.pi = User.objects.create(username="pi", first_name="Principal", last_name="Investigator", email="pi@test.com")
		...
		cls.test_project.projectbillingdetails = ProjectBillingDetails.objects.create(project=cls.test_project, expires_on=next_day)
		cls.test_project.projectbillingdetails = ProjectBillingDetails.objects.create(project=cls.test_project_2, expires_on=next_two_days)
