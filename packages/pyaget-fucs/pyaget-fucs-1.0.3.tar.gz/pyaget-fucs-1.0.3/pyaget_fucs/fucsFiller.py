...
TO UPDATE
=========
export PYAGET_VERSION=1.0.2 && python3 uploadPackageInPypi.py

export PYAGET_VERSION=1.0.2 && cd ~/Desktop/pyaget_fucs && python3 updateVersion.py && python3 -m build --sdist && twine upload dist/* && rm -R dist/*.tar.gz
"""
...
if __name__ != "__main__":
    ...
    #interface.exportTranslations("{fucName}_translation", "txt")
