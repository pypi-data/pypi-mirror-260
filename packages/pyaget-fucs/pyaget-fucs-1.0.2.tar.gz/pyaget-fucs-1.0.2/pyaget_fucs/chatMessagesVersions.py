...
PEDAGOGICAL_MODEL = """
We are Polytechnic Institute with bachelor's degrees. The total contact hours for this course is {contactHours} hours, the ECTS equal {ECTS}, and the estimated total working hours are around {workingHours}. The tutorial must have until 4 hours to Mathematics and fundamental curricular units, and until 8 hours to applied curricular units.
"""
...
CHAT_MESSAGES = {
    1.0: {# ILO and Evidence OK, but Teaching Methodologies nope
        "importantTopics": [
            ...
            #     "optimize your answer and display it on table (abbreviate syllabus topic)"),
            ...
            # ("Teaching Methodologies (TMs) and specific learning of the curricular unit",
            ...
            # ("Suggestions",
            #     "How we can integrate applied psychology in this curricular unit?"),
        ],
        "messageRoot": """
...
class UserInterface(Verbose):
    ...
    def __fileExist(self: object, filePath: str) -> (str):
        ...
        while os.path.exists(candidatePath):
            ...
            candidatePath = f"{path}/{candidate}.{extension}"
            amount += 1
            input((candidatePath, os.path.exists(candidatePath)))
