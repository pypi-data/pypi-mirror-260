...
E2E_STEPS = (
    ...
    {
        "command": ("dql", "du", "--aws-anon", "s3://ldb-public/remote/datasets/"),
    ...
    {
        "command": ("dql", "ls-datasets"),
        "expected": "(tmp) mnt\n",
    },
    {
        "command": ("dql", "ls-dataset-rows", "mnt"),
        "expected": MNT_DATASET_ROWS,
        "sort_expected_lines": True,
    },
    {
        "command": ("dql", "register", "mnt"),
    ...
    {
        "command": ("dql", "ls-dataset-rows", "mnt", "--version", "1"),
        "expected": MNT_DATASET_ROWS,
        "sort_expected_lines": True,
    },
    {
        "command": ("dql", "edit-dataset", "mnt", "--new-name", "mnt-new"),
        "expected": "",
    },
    {
        "command": ("dql", "ls-datasets"),
    ...
    {
        "command": ("dql", "ls-dataset-rows", "mnt-new", "--version", "1"),
        "expected": MNT_DATASET_ROWS,
        "sort_expected_lines": True,
    },
    {
        "command": ("dql", "rm-dataset", "mnt-new", "--version", "1"),
        "expected": "",
    },
    {
        "command": ("dql", "ls-datasets"),
