...
T = TypeVar("T", bound="AssaysSummarizeJsonBodyBaselineType2SlidingWindowWindow")


@attr.s(auto_attribs=True)
class AssaysSummarizeJsonBodyBaselineType2SlidingWindowWindow:
    """  Assay window.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        assays_summarize_json_body_baseline_type_2_sliding_window_window = cls(
            model_name=model_name,
            path=path,
            pipeline_name=pipeline_name,
            width=width,
        ...
        assays_summarize_json_body_baseline_type_2_sliding_window_window.additional_properties = d
        return assays_summarize_json_body_baseline_type_2_sliding_window_window
