...
T = TypeVar("T", bound="PublishPipelineJsonBody")


@attr.s(auto_attribs=True)
class PublishPipelineJsonBody:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        publish_pipeline_json_body = cls(
            model_config_ids=model_config_ids,
            pipeline_version_id=pipeline_version_id,
            engine_config=engine_config,
        )

        publish_pipeline_json_body.additional_properties = d
        return publish_pipeline_json_body
