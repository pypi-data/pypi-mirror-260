...
T = TypeVar("T", bound="AssaysCreateJsonBodyBaselineType0CalculatedType2SlidingWindowWindow")


@attr.s(auto_attribs=True)
class AssaysCreateJsonBodyBaselineType0CalculatedType2SlidingWindowWindow:
    """  Assay window.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        assays_create_json_body_baseline_type_0_calculated_type_2_sliding_window_window = cls(
            model_name=model_name,
            path=path,
            pipeline_name=pipeline_name,
            width=width,
        ...
        assays_create_json_body_baseline_type_0_calculated_type_2_sliding_window_window.additional_properties = d
        return assays_create_json_body_baseline_type_0_calculated_type_2_sliding_window_window
