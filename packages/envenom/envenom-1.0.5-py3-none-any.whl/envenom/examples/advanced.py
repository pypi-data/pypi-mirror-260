...
class ApplicationConfig:
    ...
    namespaced_subconfig: NamespacedSubconfig = subconfig(NamespacedSubconfig)
    non_namespaced_subconfig: NonNamespacedSubconfig = subconfig(NonNamespacedSubconfig)
    framework_config: FrameworkConfig = subconfig(FrameworkConfig)
