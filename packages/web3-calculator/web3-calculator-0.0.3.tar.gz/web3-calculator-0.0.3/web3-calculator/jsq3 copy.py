...
if __name__ == "__main__":
    ...
    # # calculate_button1 = tk.Button(button_frame, text="多", command=more)
    # # calculate_button2 = tk.Button(button_frame, text="空", command=less)
    # # calculate_button3 = tk.Button(button_frame, text="分批进场", command=batch_buy)
    # # calculate_button4 = tk.Button(button_frame, text="分批出场", command=batch_sell)
    # calculate_button1 = tk.Button(button_frame, text="多", command=lambda: switch_bg_color(1))
    # calculate_button2 = tk.Button(button_frame, text="空", command=lambda: switch_bg_color(2))
    # calculate_button3 = tk.Button(button_frame, text="分批进场", command=lambda: switch_bg_color(3))
    # calculate_button4 = tk.Button(button_frame, text="分批出场", command=lambda: switch_bg_color(4))
    # calculate_button1.pack(side="left")
    # calculate_button2.pack(side="left")
    # calculate_button3.pack(side="left")
    # calculate_button4.pack(side="left")

    # # 全局按钮id
    # global_btn_id = 1
    # # 初始化，默认加载第一个按钮
    # calculate_button1.config(bg='red')

    # # 创建输入框和标签
    # label1 = tk.Label(root, text="Costs:")
    # label1.pack()

    # input_entry1 = tk.Entry(root, width=40)
    # input_entry1.pack()

    # # 创建百分比输入框和标签
    # label2 = tk.Label(root, text="止损位:")
    # label2.pack()

    # input_entry2 = tk.Entry(root, width=40)
    # input_entry2.pack()
