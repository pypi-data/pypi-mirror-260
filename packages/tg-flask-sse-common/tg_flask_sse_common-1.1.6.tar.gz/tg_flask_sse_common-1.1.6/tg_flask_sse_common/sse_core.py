...
from .sse_constant import RedisConfig, SseBusinessEventType, SseSystemEventType, SseClientConfig
...
class Sse(object):
    ...
    def publish_connect_message(self, channel):
        """
        推送sse-end系统消息, 添加信息到redis频道
        """
        return self.sse_redis_pub_sub.publish_message(
    ...
    def publish_error_message(self, channel):
        """
