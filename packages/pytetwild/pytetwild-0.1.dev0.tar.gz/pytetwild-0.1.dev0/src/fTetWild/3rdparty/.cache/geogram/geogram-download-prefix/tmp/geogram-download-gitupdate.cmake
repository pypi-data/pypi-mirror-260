...
execute_process(
  COMMAND "/usr/bin/git" show-ref "b613750341a6cdd31ae8df80ecfc26ac7ca1a6ad"
  WORKING_DIRECTORY "/home/alex/source/pytetwild/src/fTetWild/3rdparty//geogram"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "b613750341a6cdd31ae8df80ecfc26ac7ca1a6ad")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("b613750341a6cdd31ae8df80ecfc26ac7ca1a6ad" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/b613750341a6cdd31ae8df80ecfc26ac7ca1a6ad")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/alex/source/pytetwild/src/fTetWild/3rdparty//geogram'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/alex/source/pytetwild/src/fTetWild/3rdparty//geogram'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
