...
def main():
    from kmer_counting.kmer_counting_loop import parser
...
setup(
    name='kmer_counting',  # Your package/library name
    version='0.1.0',  # Version number
    author='Qiang Su',  # Author name
    author_email='qiang_su@hotmail.com',  # Author email
    description='kmer counting from sequencing fastq.gz file',
    ...
    entry_points={
        'console_scripts': [
            ...
            'kmer_abundance=kmer_counting.kmer_counting_loop:main',
        ],
    },
)
