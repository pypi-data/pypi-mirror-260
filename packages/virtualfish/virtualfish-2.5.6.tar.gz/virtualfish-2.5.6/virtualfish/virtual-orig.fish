...
function __vf_upgrade --description "Upgrade virtualenv(s) to newer Python version"
    ...
    if set -q _flag_all
        ...
        ## But this doesn't work b/c venv_path is different.
        ## Need to handle refactor this whole function to support multiple venv paths.
        # for pipx_venv in (command ls -1 ~/.local/pipx/venvs/)
        #     set pipx_venv_list $pipx_venv_list $pipx_venv
        # end
