...
class Substance(metaclass=ABCMeta):
    ...
    def __init__(self, name: str, composition: dict[Constituent, float], mode: str = "_legacy", **kwargs) -> None:
        ...
        Raises:
            ValueError:
                If non-valid constructor mode or given constituent is not
                allowed as constituent for substance.
        """
        ...
        self._data: dict[str, float]                  # additional data for storage or calculation of mean values
        ...
        # extract variables from kwargs (or calculate)
    ...
    @property
    def data(self):
        """Additional data dictionary for storage or calculation of mean values."""
        return self._data
