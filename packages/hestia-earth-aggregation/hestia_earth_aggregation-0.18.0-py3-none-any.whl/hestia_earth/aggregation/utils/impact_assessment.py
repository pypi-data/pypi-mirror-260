...
from .cycle import _is_irrigated, _is_organic
from .term import (
...
def new_impact(cycle: dict):
    ...
    impact['country'] = cycle.get('site', {}).get('country')
    ...
    impact['organic'] = _is_organic(cycle)
    impact['irrigated'] = _is_irrigated(cycle)
