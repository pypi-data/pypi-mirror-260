...
class TalentMedia(_message.Message):
    __slots__ = ("id", "user", "title", "link", "files")
    ID_FIELD_NUMBER: _ClassVar[int]
    USER_FIELD_NUMBER: _ClassVar[int]
    ...
    title: str
    link: str
    files: _containers.RepeatedCompositeFieldContainer[_common_pb2.Document]
    def __init__(self, id: _Optional[str] = ..., user: _Optional[str] = ..., title: _Optional[str] = ..., link: _Optional[str] = ..., files: _Optional[_Iterable[_Union[_common_pb2.Document, _Mapping]]] = ...) -> None: ...
