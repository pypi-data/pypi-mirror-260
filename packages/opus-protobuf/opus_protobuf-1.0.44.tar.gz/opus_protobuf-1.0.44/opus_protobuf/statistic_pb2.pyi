...
class TalentMedia(_message.Message):
    __slots__ = ("user", "title", "link", "files")
    USER_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, user: _Optional[str] = ..., title: _Optional[str] = ..., link: _Optional[str] = ..., files: _Optional[_Iterable[_Union[_common_pb2.Document, _Mapping]]] = ...) -> None: ...
