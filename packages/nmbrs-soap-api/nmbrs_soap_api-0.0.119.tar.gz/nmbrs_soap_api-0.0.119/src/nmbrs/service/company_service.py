...
class CompanyService(Service):
    ...
    def get_all_wagetax(self, company_id: int, year: int) -> list[WageTax]:
        ...
        wage_taxes = self.company_service.service.WageTax_GetList(**data, _soapheaders=self.auth_header)
    ...
    def get_wagetax_details(self, company_id: int, loonaangifte_id) -> WageTaxXML:
        ...
        wage_tax_details = self.company_service.service.WageTax_GetXML(**data, _soapheaders=self.auth_header)
