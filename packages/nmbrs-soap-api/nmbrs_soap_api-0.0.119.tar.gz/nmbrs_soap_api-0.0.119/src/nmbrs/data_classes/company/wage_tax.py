...
class WageTax(DataClass):
    ...
    def __init__(self, obj: dict) -> None:
        ...
        self.correction_tijdvak_start: datetime | None = obj.get("CorrectionTijdvakStart", None)
        self.correction_tijdvak_end: datetime | None = obj.get("CorrectionTijdvakEnd", None)
