    ...
    def submit_mix_function(self, mix, params):
        with open(mix, 'r', newline='') as csvfile:
            ...
            for row in csv_reader:
                ...
                rc = self.run_component_service(MCAEventLoopComponent, "RUN", "FUNC_NB_DELAYED", "MIX_LOOP", int(arrival), None, None, self.submit_object, self._loopback_conn, object, params)
                if rc != DYNRM_MCA_SUCCESS:
                    return rc
        return DYNRM_MCA_SUCCESS
