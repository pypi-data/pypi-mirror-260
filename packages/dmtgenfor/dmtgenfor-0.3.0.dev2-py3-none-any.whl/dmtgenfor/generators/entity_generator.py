...
class EntityGenerator(TemplateBasedGenerator):
    ...
    def __generate_entity(
        self, blueprint, package: Package, template: Template, outputdir: Path, config: Dict
    ):
        ...
        with codecs.open(outputfile, "w", "utf-8") as file:
            file.write(template.render(type=entity_model))
    ...
    def __find_user_defined(self, outputfile,user_defined):
        ...
        with codecs.open(outputfile, "rU", "utf-8") as file:
