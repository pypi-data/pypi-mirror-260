...
pip install paravis
```
**Note:** To customize theme and cell size for a better experience within Jupyter Notebook, use the following magic command and remember to refresh Jupyter Notebook (use F5):
```bash
