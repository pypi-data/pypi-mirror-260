...
from cassandra.cluster import Cluster, Session, HostDistance, ResultSet, NoHostAvailable, ResponseFuture
...
class ORMInstance(IDatabaseService):
    ...
    def _bind_delete_or_insert(self, filtered_columns: Dict[str, Column],
        ...
        self._execute_async_query(prepared_statement, values)
