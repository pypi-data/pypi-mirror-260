...
class EasyFTP:
    ...
    def download(self, remote_path: str, local_path: str, filt : Filter.Filter = None) -> None:
    ...
    def upload(self, local_path: str, remote_path: str, filt : Filter.Filter = None) -> None:
