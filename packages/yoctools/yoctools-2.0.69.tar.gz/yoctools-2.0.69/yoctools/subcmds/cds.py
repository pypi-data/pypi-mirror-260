...
platforms = ['smartl', 'xiaohui']
kernels = ['rtthread', 'freertos']
...
"""
    ...
    def Execute(self, opt, args):
        ...
        cproject_content = cproject_template.format(
            postbuildStep_var = "sh ${PWD}/../aft_build.sh ${ProjName}",
