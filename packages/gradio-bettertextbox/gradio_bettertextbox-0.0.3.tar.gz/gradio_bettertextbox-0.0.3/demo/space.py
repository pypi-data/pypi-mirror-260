...
with gr.Blocks(
    ...
    gr.Markdown(
"""
# `gradio_bettertextbox`

<div style="display: flex; gap: 7px;">
<a href="https://pypi.org/project/gradio_bettertextbox/" target="_blank"><img alt="PyPI - Version" src="https://img.shields.io/pypi/v/gradio_bettertextbox"></a>  
</div>
...
```bash
pip install gradio_bettertextbox
```
...
""", elem_classes=["md-custom"], header_links=True)
    ...
    gr.ParamViewer(value=_docs["betterTextBox"]["members"]["__init__"], linkify=['MultiModalInput'])


    gr.Markdown("### Events")
    gr.ParamViewer(value=_docs["betterTextBox"]["events"], linkify=['Event'])
...
- **As output:** Should return, expects a {str} returned from function and sets textarea value to it.
 ...
 ```python
def predict(
    value: MultiModalInput | None
) -> MultiModalInput | None:
    return value
```
""", elem_classes=["md-custom", "betterTextBox-user-fn"], header_links=True)




    code_MultiModalInput = gr.Markdown("""
## `MultiModalInput`
```python
class MultiModalInput(GradioModel):
    text: Optional[str] = None
    images: Optional[List[FileData]] = None
```""", elem_classes=["md-custom", "MultiModalInput"], header_links=True)

    demo.load(None, js=r"""function() {
    const refs = {
            MultiModalInput: [], };
    const user_fn_refs = {
          betterTextBox: ['MultiModalInput'], };
