...
async def resolve(hub, arg_bind: str):
    """
    Parse arg_bind template ${cloud:state:attribute} or ${cloud:state[resource_name]:attribute}
    and resolve the arg-bind template into a value using the hub's RUNNING data.
    """
