...
class HP4294(object):
    ...
    def plot_permittivity(self, K1=None):
        ...
        fig.suptitle(f"Complex permittivity for 5 mM NaCl", fontweight='bold')
        plt.tight_layout()
        plt.show()
...
if __name__ == '__main__':
    ...
    meas1 = HP4294(str(file_path / "NaCl5mM.txt"))
    meas2 = HP4294(str(file_path / "original files" /"NACL5MM.001"))
