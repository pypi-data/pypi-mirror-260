...
from pingsafe_cli.psgraph.cloudformation.graph_builder.utils import get_referenced_vertices_in_value, find_all_interpolations
from pingsafe_cli.psgraph.cloudformation.graph_builder.variable_rendering.vertex_reference import VertexReference
from pingsafe_cli.psgraph.cloudformation.parser.cfn_keywords import IntrinsicFunctions, ConditionFunctions
from pingsafe_cli.psgraph.common.graph.graph_builder import Edge, CustomAttributes
...
if TYPE_CHECKING:
    ...
    from pingsafe_cli.psgraph.cloudformation.graph_builder.local_graph import CloudformationLocalGraph
