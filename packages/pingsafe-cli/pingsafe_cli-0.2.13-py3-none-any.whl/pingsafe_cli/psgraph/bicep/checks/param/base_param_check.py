...
from pingsafe_cli.psgraph.bicep.checks.param.registry import registry
...
class PingSafeParameterAttributes(ParameterAttributes):
...
class BaseParamCheck(BaseCheck):
    ...
    def scan_entity_conf(self, conf: PingSafeParameterAttributes, entity_type: str) -> CheckResult:  # type:ignore[override]  # it's ok
        self.entity_type = entity_type

        return self.scan_param_conf(conf)

    @abstractmethod
    def scan_param_conf(self, conf: PingSafeParameterAttributes) -> CheckResult:
