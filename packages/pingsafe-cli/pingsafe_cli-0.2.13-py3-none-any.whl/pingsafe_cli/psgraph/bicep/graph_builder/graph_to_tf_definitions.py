...
from pingsafe_cli.psgraph.bicep.graph_builder.graph_components.block_types import BlockType, BlockTypeAlias
from pingsafe_cli.psgraph.bicep.graph_builder.local_graph import BicepElements, BicepElementsAlias

if TYPE_CHECKING:
    from pingsafe_cli.psgraph.bicep.graph_builder.graph_components.blocks import BicepBlock
