...
from pingsafe_cli.psgraph.common.runners.base_runner import ignored_directories, safe_remove
...
def filter_excluded_paths(
    ...
    """Special build of pingsafe_cli.psgraph.common.runners.base_runner.filter_ignored_paths for Secrets scanning"""
