...
from pingsafe_cli.psgraph.common.util.file_utils import decompress_file_gzip_base64
...
def transforms_policies_to_detectors_list(custom_secrets: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    for secret_policy in custom_secrets:
        parsed = False
        check_id = secret_policy['pingsafeCheckId'] if secret_policy['pingsafeCheckId'] else \
