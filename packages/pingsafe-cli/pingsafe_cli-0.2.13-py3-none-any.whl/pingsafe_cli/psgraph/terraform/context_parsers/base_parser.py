...
from pingsafe_cli.psgraph.common.models.enums import ContextCategories
from pingsafe_cli.psgraph.common.util.parser_utils import get_abs_path
...
class BaseContextParser(ABC):
    ...
    def is_optional_comment_line(line: str) -> bool:
        ...
        return "pingsafe:skip=" in line_without_whitespace

    def _collect_skip_comments(self, definition_blocks: List[Dict[str, Any]]) -> Dict[str, Any]:
        """
        Collects pingsafe skip comments to all definition blocks
