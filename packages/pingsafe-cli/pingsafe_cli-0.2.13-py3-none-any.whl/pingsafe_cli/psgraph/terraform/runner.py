...
from pingsafe_cli.psgraph.common.images.image_referencer import ImageReferencerMixin
...
from pingsafe_cli.psgraph.common.output.graph_record import GraphRecord
from pingsafe_cli.psgraph.common.output.record import Record
from pingsafe_cli.psgraph.common.output.report import Report, merge_reports, remove_duplicate_results
from pingsafe_cli.psgraph.common.pingsafe.check_type import CheckType
from pingsafe_cli.psgraph.common.runners.base_runner import BaseRunner, PINGSAFE_CREATE_GRAPH
from pingsafe_cli.psgraph.common.util import data_structures_utils
from pingsafe_cli.psgraph.common.util.consts import RESOLVED_MODULE_ENTRY_NAME
from pingsafe_cli.psgraph.common.util.parser_utils import get_module_from_full_path, get_abs_path, \
...
from pingsafe_cli.psgraph.common.util.secrets import omit_secret_value_from_checks, omit_secret_value_from_graph_checks
...
from pingsafe_cli.psgraph.terraform.checks.utils.dependency_path_handler import PATH_SEPARATOR
from pingsafe_cli.psgraph.terraform.context_parsers.registry import parser_registry
from pingsafe_cli.psgraph.terraform.evaluation.base_variable_evaluation import BaseVariableEvaluation
...
from pingsafe_cli.psgraph.terraform.graph_builder.graph_to_tf_definitions import convert_graph_vertices_to_tf_definitions
from pingsafe_cli.psgraph.terraform.graph_builder.local_graph import TerraformLocalGraph
from pingsafe_cli.psgraph.terraform.graph_manager import TerraformGraphManager
from pingsafe_cli.psgraph.terraform.image_referencer.manager import TerraformImageReferencerManager
from pingsafe_cli.psgraph.terraform.parser import Parser
from pingsafe_cli.psgraph.terraform.tf_parser import TFParser
from pingsafe_cli.psgraph.terraform.plan_utils import get_resource_id_without_nested_modules
from pingsafe_cli.psgraph.terraform.tag_providers import get_resource_tags
...
if TYPE_CHECKING:
    ...
    from pingsafe_cli.psgraph.common.typing import TFDefinitionKeyType
...
class Runner(ImageReferencerMixin[None], BaseRunner[TerraformGraphManager]):
    ...
    def __init__(
        ...
        self.parser = parser or TFParser() if strtobool(os.getenv('PINGSAFE_NEW_TF_PARSER', 'False')) else Parser()
    ...
    def generate_graph(self,
        ...
        local_graph, self.definitions = self.graph_manager.build_graph_from_source_directory(
            ...
            create_graph=PINGSAFE_CREATE_GRAPH,
        )
