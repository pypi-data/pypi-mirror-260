...
from pingsafe_cli.psgraph.common.pingsafe.severities import Severities, Severity
from pingsafe_cli.psgraph.common.models.enums import CheckResult, ScanDataFormat
from pingsafe_cli.psgraph.common.output.extra_resource import ExtraResource
from pingsafe_cli.psgraph.common.output.record import Record, DEFAULT_SEVERITY, SCA_PACKAGE_SCAN_CHECK_NAME, SCA_LICENSE_CHECK_NAME
from pingsafe_cli.psgraph.common.packaging import version as packaging_version
from pingsafe_cli.psgraph.common.sca.commons import (
...
from pingsafe_cli.psgraph.common.output.common import format_licenses_to_string

if TYPE_CHECKING:
    from aiohttp import ClientSession
    from pingsafe_cli.psgraph.common.output.common import SCADetails
    from pingsafe_cli.psgraph.common.output.report import Report
    from pingsafe_cli.psgraph.common.typing import _LicenseStatus, _CheckResult, _ScaSuppressions
...
def create_report_license_record(
    ...
    # renaming the status name from the one in platform's report to be convenient with pingsafe's-report
