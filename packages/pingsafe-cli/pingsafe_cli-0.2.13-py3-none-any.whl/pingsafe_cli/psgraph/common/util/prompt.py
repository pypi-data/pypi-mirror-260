...
from pingsafe_cli.psgraph.common.util.banner import banner as pingsafe_banner
import click
import jinja2
import os

PINGSAFE_ROOT_DIRECTORY = os.path.join(".", "pingsafe")
...
class Check(Prompt):
    ...
    def add(self) -> None:
        print("Please ensure you are at the root of the PingSafe repository before completing this prompt")
    ...
    def create_check(self) -> None:
        ...
        ck_loc = os.path.abspath(os.path.join(PINGSAFE_ROOT_DIRECTORY,
    ...
    def create_unit_test_stubs(self) -> None:
        base = os.path.abspath(os.path.join(PINGSAFE_ROOT_DIRECTORY, os.path.pardir,
