...
from pingsafe_cli.psgraph.example_runner.checks.job_registry import registry as job_registry
...
class Runner(YamlRunner):
    ...
    # MY_TYPE is defined in report.py in pingsafe_cli.psgraph/common/output
    # class CheckType:
    # ...
    #   MY_TYPE = "my_type"
    #
