...
from pingsafe_cli.psgraph.common.vcs.base_vcs_dal import BaseVCSDAL
...
class Gitlab(BaseVCSDAL):
    ...
    def setup_conf_dir(self) -> None:
        """
            discover parameters from execution context of PingSafe and determine the directory to save temporal files of vcs configuration
        """
    ...
    def discover(self) -> None:
        """
            discover parameters from execution context of pingsafe. usually from env variable
        """
