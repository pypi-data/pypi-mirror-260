...
from pingsafe_cli.psgraph.circleci_pipelines.image_referencer.manager import CircleCIImageReferencerManager
...
from pingsafe_cli.psgraph.circleci_pipelines.registry import registry
