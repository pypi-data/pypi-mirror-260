...
from pingsafe_cli.psgraph.common.util.consts import RESOURCE_ATTRIBUTES_TO_OMIT_UNIVERSAL_MASK
...
if TYPE_CHECKING:
    ...
    from pingsafe_cli.psgraph.common.typing import _CheckResult, ResourceAttributesToOmit
