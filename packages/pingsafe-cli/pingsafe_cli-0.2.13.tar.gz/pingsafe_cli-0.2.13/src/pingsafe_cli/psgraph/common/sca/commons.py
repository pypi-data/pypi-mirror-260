...
TWISTCLI_TO_PINGSAFE_LANG_NORMALIZATION = {
    "gem": "ruby",
    "nuget": "dotNet"
}
...
def normalize_twistcli_language(language: str) -> str:
    """
    part of the language names that are returned by twistcli may be a little differ from those we use in pingsafe.
    this function's goal is to normalize them
    """
    return TWISTCLI_TO_PINGSAFE_LANG_NORMALIZATION.get(language, language)
