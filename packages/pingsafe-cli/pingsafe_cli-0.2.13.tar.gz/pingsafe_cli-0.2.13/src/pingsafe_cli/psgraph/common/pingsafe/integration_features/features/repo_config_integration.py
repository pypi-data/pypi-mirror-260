...
from pingsafe_cli.psgraph.common.pingsafe.code_categories import CodeCategoryConfiguration, CodeCategoryType
...
from pingsafe_cli.psgraph.common.pingsafe.severities import Severities, BcSeverities
