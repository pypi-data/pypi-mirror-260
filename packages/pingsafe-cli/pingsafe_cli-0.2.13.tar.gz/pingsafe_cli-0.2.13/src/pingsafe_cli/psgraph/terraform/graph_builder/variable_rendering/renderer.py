...
from pingsafe_cli.psgraph.common.graph.graph_builder.utils import join_trimmed_strings
from pingsafe_cli.psgraph.common.graph.graph_builder.variable_rendering.renderer import VariableRenderer
...
from pingsafe_cli.psgraph.common.graph.graph_builder.graph_components.attribute_names import CustomAttributes, reserved_attribute_names
from pingsafe_cli.psgraph.terraform.graph_builder.graph_components.block_types import BlockType
from pingsafe_cli.psgraph.terraform.graph_builder.utils import (
...
from pingsafe_cli.psgraph.terraform.graph_builder.variable_rendering.vertex_reference import VertexReference
import pingsafe_cli.psgraph.terraform.graph_builder.variable_rendering.evaluate_terraform as evaluator
...
class TerraformVariableRenderer(VariableRenderer):
    ...
    def evaluate_value(self, val: Any) -> Any:
        ...
        if PINGSAFE_RENDER_MAX_LEN and 0 < PINGSAFE_RENDER_MAX_LEN < val_length:
