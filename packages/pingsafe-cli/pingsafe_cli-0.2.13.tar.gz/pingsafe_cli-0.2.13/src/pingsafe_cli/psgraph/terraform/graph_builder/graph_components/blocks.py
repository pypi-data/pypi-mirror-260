...
from pingsafe_cli.psgraph.terraform.graph_builder.utils import INTERPOLATION_EXPR
...
from pingsafe_cli.psgraph.terraform.graph_builder.utils import remove_module_dependency_in_path
...
class TerraformBlock(Block):
    ...
    def __init__(self, name: str, config: Dict[str, Any], path: str, block_type: BlockType, attributes: Dict[str, Any],
        ...
        if strtobool(os.getenv('PINGSAFE_NEW_TF_PARSER', 'False')):
