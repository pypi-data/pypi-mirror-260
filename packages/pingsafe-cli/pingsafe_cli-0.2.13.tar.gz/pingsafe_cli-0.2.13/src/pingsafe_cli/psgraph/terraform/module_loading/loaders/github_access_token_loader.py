...
from pingsafe_cli.psgraph.terraform.module_loading.loaders.git_loader import GenericGitLoader
from pingsafe_cli.psgraph.terraform.module_loading.module_params import ModuleParams
