...
from pingsafe_cli.psgraph.kubernetes.checks.resource.registry import registry
...
from pingsafe_cli.psgraph.kubernetes.image_referencer.manager import KubernetesImageReferencerManager
from pingsafe_cli.psgraph.kubernetes.kubernetes_utils import (
    create_definitions,
...
if TYPE_CHECKING:
    ...
    from pingsafe_cli.psgraph.common.typing import _CheckResult, _EntityContext
...
class Runner(ImageReferencerMixin[None], BaseRunner[KubernetesGraphManager]):
    ...
    def run(
        ...
        if self.context is None or self.definitions is None:
            ...
            if PINGSAFE_CREATE_GRAPH and self.graph_manager:
