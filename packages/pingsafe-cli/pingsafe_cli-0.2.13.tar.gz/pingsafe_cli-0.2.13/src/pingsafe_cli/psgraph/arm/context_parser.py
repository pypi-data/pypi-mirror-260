...
from pingsafe_cli.psgraph.common.util.consts import LINE_FIELD_NAMES, START_LINE, END_LINE
...
class ContextParser:
    ...
    def collect_skip_comments(resource: dict[str, Any]) -> list[_SkippedCheck]:
        ...
        if "metadata" in resource:
            if "pingsafe" in resource["metadata"]:
                for item in force_list(resource["metadata"]["pingsafe"]):
