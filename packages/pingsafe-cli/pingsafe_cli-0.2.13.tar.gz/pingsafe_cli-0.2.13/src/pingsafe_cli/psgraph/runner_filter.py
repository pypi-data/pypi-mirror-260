...
from pingsafe_cli.psgraph.secrets.consts import ValidationStatus

from pingsafe_cli.psgraph.common.pingsafe.code_categories import CodeCategoryMapping, CodeCategoryConfiguration, CodeCategoryType
from pingsafe_cli.psgraph.common.pingsafe.severities import Severity, Severities
from pingsafe_cli.psgraph.common.util.consts import DEFAULT_EXTERNAL_MODULES_DIR
from pingsafe_cli.psgraph.common.util.type_forcers import convert_csv_string_arg_to_list
from pingsafe_cli.psgraph.common.util.str_utils import convert_to_seconds
...
class RunnerFilter(object):
    ...
    def __init__(
            ...
            include_all_pingsafe_policies: bool = True,
        ...
        self.include_all_pingsafe_policies = include_all_pingsafe_policies
    ...
    def should_run_check(
        ...
        should_skip_check = (
            ...
            explicit_skip or
            regex_match or
            (not bc_check_id and not self.include_all_pingsafe_policies and not is_external and not explicit_run) or
        ...
        logging.debug(
            f'bc_check_id = {bc_check_id}, include_all_pingsafe_policies = {self.include_all_pingsafe_policies}, is_external = {is_external}, explicit_run: {explicit_run}')
    ...
    def from_dict(obj: Dict[str, Any]) -> RunnerFilter:
        ...
        include_all_pingsafe_policies = obj.get('include_all_pingsafe_policies')
        if include_all_pingsafe_policies is None:
            include_all_pingsafe_policies = True
        ...
        runner_filter = RunnerFilter(framework, checks, skip_checks, include_all_pingsafe_policies,
