...
class UpdateManifest(_message.Message):
    __slots__ = ["event_id", "field", "string", "tag_id", "erc20"]
    ...
    string: str
    tag_id: bytes
    erc20: Erc20Definition
    def __init__(self, event_id: _Optional[bytes] = ..., field: _Optional[_Union[UpdateManifest.ManifestField, str]] = ..., string: _Optional[str] = ..., tag_id: _Optional[bytes] = ..., erc20: _Optional[_Union[Erc20Definition, _Mapping]] = ...) -> None: ...
...
class CommitCartRequest(_message.Message):
    __slots__ = ["request_id", "cart_id", "erc20_nickname"]
    REQUEST_ID_FIELD_NUMBER: _ClassVar[int]
    CART_ID_FIELD_NUMBER: _ClassVar[int]
    ERC20_NICKNAME_FIELD_NUMBER: _ClassVar[int]
    request_id: bytes
    cart_id: bytes
    erc20_nickname: str
    def __init__(self, request_id: _Optional[bytes] = ..., cart_id: _Optional[bytes] = ..., erc20_nickname: _Optional[str] = ...) -> None: ...
...
class Erc20Definition(_message.Message):
    __slots__ = ["nickname", "contract_address"]
    NICKNAME_FIELD_NUMBER: _ClassVar[int]
    CONTRACT_ADDRESS_FIELD_NUMBER: _ClassVar[int]
    nickname: str
    contract_address: bytes
    def __init__(self, nickname: _Optional[str] = ..., contract_address: _Optional[bytes] = ...) -> None: ...
