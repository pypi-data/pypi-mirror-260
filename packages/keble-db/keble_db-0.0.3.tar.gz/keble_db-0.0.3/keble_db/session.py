...
class Db:
    ...
    @property
    def sql_write_engine(self):
        return self.__sql_write_engine

    @property
    def sql_read_engine(self):
    ...
    def get_sql_write_client(self):
        return Session(self.sql_write_engine)

    def get_sql_read_client(self):
    ...
    @staticmethod
    def ready_qdrant(client: QdrantClient, collection: str, vectors_config: Union[qdrant_models.VectorParams, Mapping[str, qdrant_models.VectorParams]]):
