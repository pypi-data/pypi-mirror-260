...
class Tooltip(SecondaryWindow):
    ...
    when the mouse touches the tooltip itself. The popup is not shown when the
    existing widget is disabled.
    ...
    def setup_tooltip(self) -> None:
        ...
        self._bindings_tooltip = (
            ...
            self.wparent.binding('<Enter>', self.__tryschedule,
    ...
    def enable(self, *, immediate: bool = True):
        ...
        assert _benter.sequence == '<Enter>' and _benter.action == self.__tryschedule  # Check `__enable_checkcontaining`
    ...
    def disable(self, *, immediate: bool = True):
        ...
        assert _benter.action == self.__tryschedule
