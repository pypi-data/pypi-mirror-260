...
def iter_layouts(self, activeDoc=None, skip_modelspace=True):
        ...
        :param activeDoc: If doc is not specified (default), :attr:ActiveDocument will be used to iterate layouts from.
        :param skip_modelspace: In cases of True, :class:ModelSpace should not be included.
        """
...
def iter_objects(self, obj_or_list=None, block=None,
                     limit=None, dont_cast=False):
        """Iterate objects from `block`

        :param obj_or_list: Have an object type name include a part of it, or list of it.
        :param block: Application block, if no input is given default - :class:`ActiveDocument.ActiveLayout.Block` is taken
        :param limit: max number of objects to return, default infinite is taken.
        :param dont_cast: Iteration may be accelerated by avoiding retrieval of the best interface for the object. Casting of returned objects is the caller's responsibility.
        """
        if block is None:
...
def find_one(self, obj_or_list, container=None, predicate=None):
    ...
    :param obj_name_or_list: Have an object type name include a part of it, or list of it.
    :param container: like in :meth:`iter_objects`
    :param predicate: Returning True or False upon accepting an object as an argument in callable.
    :returns: Object, Default:None
    """
...
def get_selection(self, text="Select objects"):
        ...
        :param text: text prompt for selection of objects
        """
