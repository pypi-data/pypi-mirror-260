...
class Rubric(abc.ABC):
    """A Rubric is a mechanism for producing inference-level performance scores
    for the output of an inference service on a given inference task.
    """

    @property
    @abc.abstractmethod
    def name(self) -> str:
        """The "semi-qualified" type name of the Rubric. The result should be
