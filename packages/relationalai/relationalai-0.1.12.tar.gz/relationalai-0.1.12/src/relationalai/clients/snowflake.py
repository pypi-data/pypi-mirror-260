...
def Graph(name, *, profile:str|None=None, config:Config|None=None, dry_run:bool=False):
    client = Client(Resources(profile, config), rel.Compiler(), name, dry_run=dry_run)
