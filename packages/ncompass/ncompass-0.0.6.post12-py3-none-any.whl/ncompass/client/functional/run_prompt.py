...
def stream_prompt_legacy(url: str
                  , miid: str
                  , prompt: str
                  , max_tokens: int
                  , temperature: float
...
def stream_prompt(session
    ...
    try:
        ...
        res = loop.run_until_complete(async_streaming_post_json(session
                                                                , _url
                                                                , body
                                                                , headers
        ...
        res = asyncio.run_coroutine_threadsafe(async_streaming_post_json(session
                                                                , _url
                                                                , body
                                                                , headers
                                                                , stream_response_handler), loop).result()
