...
class SetCoverProto(google.protobuf.message.Message):
    ...
    class Subset(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["_cost", b"_cost", "cost", b"cost"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["_cost", b"_cost", "cost", b"cost", "element", b"element"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["_cost", b"_cost"]) -> typing_extensions.Literal["cost"] | None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["_fingerprint", b"_fingerprint", "_name", b"_name", "fingerprint", b"fingerprint", "name", b"name"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_fingerprint", b"_fingerprint", "_name", b"_name", "fingerprint", b"fingerprint", "name", b"name", "subset", b"subset"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_fingerprint", b"_fingerprint"]) -> typing_extensions.Literal["fingerprint"] | None: ...
    @typing.overload
