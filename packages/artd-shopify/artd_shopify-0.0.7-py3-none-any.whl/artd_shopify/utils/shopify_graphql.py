            ...
            for variant in variants:
                ...
                for shopify_image in shopify_images:
                    if (
                        ...
                        # delete images form disk using shopify_images
                        # image_path = shopify_image.image.path
                        # image_path = image_path.replace("..png", ".png")
                        # image_path = image_path.replace("..jpg", ".jpg")
                        # image_path = image_path.replace("..jpeg", ".jpeg")
                        # image_path = image_path.replace("..gif", ".gif")
                        # image_path = image_path.replace("..webp", ".webp")
                        # image_path = image_path.replace("..bmp", ".bmp")
                        # image_path = image_path.replace("..tiff", ".tiff")
                        # image_path = image_path.replace("..svg", ".svg")
                        # image_path = image_path.replace("..ico", ".ico")
