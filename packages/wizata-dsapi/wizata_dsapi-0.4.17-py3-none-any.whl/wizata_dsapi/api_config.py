    ...
    "components":
        {
            ...
            "cloud_context": ['lists', 'get_by_id', 'create', 'update', 'delete']
        },
    "dataframes":
        {
            "class": DSDataFrame,
    ...
    "datapoints":
        {
            ...
            "cloud_context": ['lists', 'get_by_id', 'get_by_key', 'create', 'update', 'delete']
        },
    "executions":
        {
            "class": Execution,
    ...
    "templates":
        {
            "class": Template,
            "cloud_dsapi": ['lists', 'get_by_id', 'get_by_key', 'create', 'update', 'delete'],
            "cloud_context": ['lists', 'get_by_id', 'get_by_key']
        },
    "triggers":
        {
            "class": Trigger,
