...
from proteusPy.data import (PROBLEM_ID_FILE, SS_DICT_PICKLE_FILE, SS_ID_FILE,
                            SS_PICKLE_FILE, SS_TORSIONS_FILE)
from proteusPy.DisulfideExceptions import *
from proteusPy.DisulfideList import DisulfideList
# tqdm progress bar width
from proteusPy.ProteusGlobals import (_ANG_INIT, _FLOAT_INIT, MODEL_DIR,
                                      PBAR_COLS, PDB_DIR, WINSIZE)
