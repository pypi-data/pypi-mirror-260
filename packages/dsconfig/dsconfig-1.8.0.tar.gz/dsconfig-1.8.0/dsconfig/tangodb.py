...
def get_dict_from_db(db, data, narrow=False, skip_protected=True):
    ...
    for server, inst, clss, device, _ in get_devices_from_dict(
            data.get("servers", {})):
        try:
