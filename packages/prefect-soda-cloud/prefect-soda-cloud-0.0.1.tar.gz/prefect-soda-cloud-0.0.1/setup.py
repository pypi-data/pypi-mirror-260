...
setup(
    ...
    description="Collection of Prefect tasks to interact with Soda Cloud APIs.",
    license="Apache License 2.0",
    author="Alessandro Lollo",
    author_email="alessandro.lollo@gmail.com",
    keywords="prefect",
    url="https://github.com/AlessandroLollo/prefect-soda-cloud",
    ...
    entry_points={
        "prefect.collections": [
            "prefect_soda_cloud = prefect_soda_cloud",
        ]
    },
    classifiers=[
