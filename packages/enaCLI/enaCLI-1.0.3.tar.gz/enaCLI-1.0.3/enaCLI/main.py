...
def get_args(): # https://docs.python.org/3/library/argparse.html
    epilog = ("""
            ...
            For any error or assistance please contact the ENA helpdesk: \033[94mhttps://www.ebi.ac.uk/ena/browser/support \033[93m(3)\033[94m Tempalte: https://github.com/KhadimGueyeKGY/ena-CLI/blob/master/templates/templates.xlsx\033[0m
        """) 
