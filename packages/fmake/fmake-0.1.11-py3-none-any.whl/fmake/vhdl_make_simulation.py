...
def vhdl_make_simulation_intern(entity,BuildFolder = constants.default_build_folder ):  
    ...
    save_file(OutputPath+ constants.text_IO_polling +"/poll.txt","0")
    save_file(OutputPath+ constants.text_IO_polling +"/write_poll.txt",
"""Time, N
0,     0
""")
    save_file(OutputPath+ constants.text_IO_polling +"/read.txt","")
    save_file(OutputPath+ constants.text_IO_polling +"/write.txt","")    
