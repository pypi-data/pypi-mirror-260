...
architecture rtl of csv_text_io_poll is
    ...
    constant send_lock_FileName    : string    := FileName & "/send_lock.txt";
    constant send_FileName         : string    := FileName & "/send.txt";
    
    constant receive_FileName      : string    := FileName & "/receive.txt";
    constant receive_lock_FileName : string    := FileName & "/receive_lock.txt";
