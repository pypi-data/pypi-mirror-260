        ...
        if df_results is not None:
            ...
            params = TableParam(
                ...
                columns = [
                    ...
                    ColumnParam(title = 'Critical',     type = 'int',  data_col = 'Critical', group = 'Controls', footer = 'sum', critical_hi=1),
                    ColumnParam(title = 'High',     type = 'int',  data_col = 'High', group = 'Controls', footer = 'sum', alarm_hi=1),
                    ColumnParam(title = 'Medium',     type = 'int',  data_col = 'Medium', group = 'Controls', footer = 'sum', warning_hi=1),
