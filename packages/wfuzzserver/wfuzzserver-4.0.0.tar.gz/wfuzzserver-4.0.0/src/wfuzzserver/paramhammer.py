...
#addthread.start()
ph = ParamHammer(url="http://testphp.vulnweb.com/search.php?test=query",method="get",headers={},body="",delay=2,request_types=["get","postxml","postform","postmultipart"],value_type="custom",custom_value="111")
for p in ph: #ph.fuzz():
    print(p)
