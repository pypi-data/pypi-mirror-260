...
#addthread.start()
ph = HeaderHammer(url="https://0a9b008603bb8712809d3f4b005b00a8.web-security-academy.net/",method="get",headers={"Cookie":"session=8t89mFQqZBMrAECqBZuaqVpb5VXX83M6","Host":"0a9b008603bb8712809d3f4b005b00a8.web-security-academy.net","User-Agent":"Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:123.0) Gecko/20100101 Firefox/123.0"},body="",value_type="normal")
for p in ph: #ph.fuzz():
    print(p)
