    ...
    "Statement": [
        {
            ...
            "Resource": "arn:aws:s3:::django-backend-dev-private",
        },
        {
            "Sid": "",
            "Effect": "Allow",
...
MINIO_EXTERNAL_ENDPOINT_USE_HTTPS = bool(
    distutils.util.strtobool(os.getenv("GH_MINIO_EXTERNAL_ENDPOINT_USE_HTTPS", "true"))
)
...
MINIO_USE_HTTPS = bool(
    distutils.util.strtobool(os.getenv("GH_MINIO_USE_HTTPS", "true"))
)
