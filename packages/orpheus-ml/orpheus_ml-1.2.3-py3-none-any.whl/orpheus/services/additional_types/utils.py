...
class MultiEstimatorPipelineScoreTracker:
    ...
    def update_scores(self, scores: np.ndarray[float], max_len: int = 10) -> None:
        """
    ...
    def _update_scores(self, scores: np.ndarray[float], max_len: int = 10) -> None:
    ...
    def _handle_value_error_update_scores(self, scores: np.ndarray[float], max_len: int, e: ValueError):
