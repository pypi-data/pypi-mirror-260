...
def _stacked_predict_range(
    ...
    for N in range(*top_n_per_tuner_range):
        ...
        fitted_models = {
            k: v | fitted_models_dict[k] if fitted_models_dict[k] is not None else dict()
...
) -> Tuple[MultiEstimatorPipeline, pd.DataFrame] | MultiEstimatorPipeline:
    """
