...
class Evaluator:
    ...
    def evaluate_performance(
        self, y_true: np.ndarray[float], y_pred: np.ndarray[np.ndarray[float]]
    ) -> float | pd.Series:
        """
    ...
    def _get_pred_dist_classification(self, y_pred: np.ndarray[np.ndarray[float]], unique_classes: np.ndarray):
        pred_gen = map(
    ...
    def _plot_dist_regression(self, y_true: np.ndarray[float], y_pred_list: np.ndarray[np.ndarray[float]]):
    ...
    def _plot_dist_classification(self, y_true: np.ndarray[float], y_pred: np.ndarray[np.ndarray[float]]):
    ...
    def _plot_scatter(self, y_true: np.ndarray[float], y_pred: np.ndarray[float], y_colors: List[str], ax: plt.Axes):
    ...
    def _get_fig_and_axs(self, y_pred_list: np.ndarray[float]) -> Tuple[int, plt.Figure, np.ndarray[plt.Axes]]:
