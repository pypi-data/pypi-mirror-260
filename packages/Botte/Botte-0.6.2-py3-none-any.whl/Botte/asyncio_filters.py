...
from Botte.asyncio_handler_backends import State
...
class TextFilter:
    ...
    example of usage is in examples/asynchronous_Botte/custom_filters/advanced_text_filter.py
...
class TextContainsFilter(AdvancedCustomFilter):
    ...
    .. code-block:: python3
        ...
        @bot.handle_msg(text_contains=['account'])
        # your function
    """
...
class TextStartsFilter(AdvancedCustomFilter):
    ...
    .. code-block:: python3
        ...
        @bot.handle_msg(text_startswith='sir')
        # your function
    """
...
class ForwardFilter(SimpleCustomFilter):
    ...
    .. code-block:: python3 
        ...
        @bot.handle_msg(is_forwarded=True)
        # your function
    """
...
class LanguageFilter(AdvancedCustomFilter):
    ...
    .. code-block:: python3
        ...
        @bot.handle_msg(language_code=['ru'])
        # your function
    """
...
class IsAdminFilter(SimpleCustomFilter):
    ...
    .. code-block:: python3
        ...
        @bot.handle_msg(chat_types=['supergroup'], is_chat_admin=True)
        # your function
    """
