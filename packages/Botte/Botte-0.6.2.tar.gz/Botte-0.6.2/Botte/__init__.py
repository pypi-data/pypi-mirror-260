...
import Botte.util
import Botte.types
import Botte.formatting

# storage
from Botte.storage import StatePickleStorage, StateMemoryStorage, StateStorageBase
...
from Botte import apihelper, util, types
from Botte.handler_backends import (
    HandlerBackend, MemoryHandlerBackend, FileHandlerBackend, BaseMiddleware,
    CancelUpdate, SkipHandler, State, ContinueHandling
)
from Botte.custom_filters import SimpleCustomFilter, AdvancedCustomFilter
...
class Botte:
    ...
    .. code-block:: python3
        :caption: Creating instance of Botte

        from Botte import Botte
        bot = Botte('token') # get token from @BotFather
        # now you can register other handlers/update listeners, 
        # and use bot methods.

    See more examples in examples/ directory:
    https://github.com/Kreaitorai/botte/tree/master/examples
    ...
    :type next_step_backend: :class:`Botte.handler_backends.HandlerBackend`, optional

    :param reply_backend: Reply step handler class, defaults to None
    :type reply_backend: :class:`Botte.handler_backends.HandlerBackend`, optional

    :param exception_handler: Exception handler to handle errors, defaults to None
    :type exception_handler: :class:`Botte.ExceptionHandler`, optional
    ...
    :type state_storage: :class:`Botte.storage.StateStorageBase`, optional
    ...
    def enable_saving_states(self, filename: Optional[str]="./.state-save/states.pkl"):
        ...
        .. note::
            It is recommended to pass a :class:`~Botte.storage.StatePickleStorage` instance as state_storage
            to Botte class.
    ...
    def run_webhooks(self,
        ...
        # webhooks module
        try:
            from Botte.ext.sync import SyncWebhookListener
    ...
    def get_updates(self, offset: Optional[int]=None, limit: Optional[int]=None, 
        ...
        :rtype: :obj:`list` of :class:`Botte.types.Update`
        """
    ...
    def process_new_updates(self, updates: List[types.Update]):
        ...
        :param updates: List of :class:`Botte.types.Update` objects.
        :type updates: :obj:`list` of :class:`Botte.types.Update`
    ...
    def process_new_messages(self, new_messages):
        ...
        self._notify_command_handlers(self.handle_msgs, new_messages, 'message')

    def process_new_edited_messages(self, new_edited_message):
        """
        :meta private:
        """
        self._notify_command_handlers(self.edited_handle_msgs, new_edited_message, 'edited_message')
    ...
    def _setup_change_detector(self, path_to_watch: str):
        try:
            ...
            from Botte.ext.reloader import EventHandler
        except ImportError:
            raise ImportError(
    ...
    def runthebot(self, timeout: Optional[int]=20, skip_pending: Optional[bool]=False, long_polling_timeout: Optional[int]=20,
        ...
        :param logger_level: Custom (different from logger itself) logging level for runthebot logging.
    ...
    def set_message_reaction(self, chat_id: Union[int, str], message_id: int, reaction: Optional[List[types.ReactionType]]=None, is_big: Optional[bool]=None) -> bool:
        ...
        :type reaction: :obj:`list` of :class:`Botte.types.ReactionType`
    ...
    def get_user_profile_photos(self, user_id: int, offset: Optional[int]=None, 
        ...
        Returns a :class:`Botte.types.UserProfilePhotos` object.
    ...
    def get_chat_administrators(self, chat_id: Union[int, str]) -> List[types.ChatMember]:
        ...
        :rtype: :obj:`list` of :class:`Botte.types.ChatMember`
        """
    ...
    def get_chat_member(self, chat_id: Union[int, str], user_id: int) -> types.ChatMember:
        ...
        :rtype: :class:`Botte.types.ChatMember`
        """
    ...
    def send_message(
        ...
        :type entities: Array of :class:`Botte.types.MessageEntity`
        ...
        :type reply_markup: :class:`Botte.types.InlineKeyboardMarkup` or :class:`Botte.types.ReplyKeyboardMarkup` or :class:`Botte.types.ReplyKeyboardRemove`
            or :class:`Botte.types.ForceReply`
        ...
        :type reply_parameters: :class:`Botte.types.ReplyParameters`
    ...
    def copy_message(
        ...
        :type caption_entities: Array of :class:`Botte.types.MessageEntity`
    ...
    def copy_messages(self, chat_id: Union[str, int], from_chat_id: Union[str, int], message_ids: List[int],
            ...
            :rtype: :obj:`list` of :class:`Botte.types.MessageID`
            """
            disable_notification = self.disable_notification if disable_notification is None else disable_notification
            protect_content = self.protect_content if protect_content is None else protect_content
    ...
    def send_photo(
        ...
        :type photo: :obj:`str` or :class:`Botte.types.InputFile`
    ...
    def send_audio(
        ...
        :type audio: :obj:`str` or :class:`Botte.types.InputFile`
        ...
        :type thumbnail: :obj:`str` or :class:`Botte.types.InputFile`
        ...
        :type thumb: :obj:`str` or :class:`Botte.types.InputFile`
    ...
    def send_voice(
        ...
        :type voice: :obj:`str` or :class:`Botte.types.InputFile`
    ...
    def send_document(
        ...
        :type document: :obj:`str` or :class:`Botte.types.InputFile`
    ...
    def send_sticker(
        ...
        :type sticker: :obj:`str` or :class:`Botte.types.InputFile`
    ...
    def send_video(
        ...
        :type video: :obj:`str` or :class:`Botte.types.InputFile`
    ...
    def send_animation(
        ...
        :type animation: :obj:`str` or :class:`Botte.types.InputFile`
    ...
    def send_video_note(
        ...
        :type data: :obj:`str` or :class:`Botte.types.InputFile`
    ...
    def edit_message_live_location(
        ...
        :rtype: :class:`Botte.types.Message` or bool
        """
        return types.Message.de_json(
    ...
    def get_my_commands(self, scope: Optional[types.BotCommandScope]=None, 
        ...
        :type scope: :class:`Botte.types.BotCommandScope`
        ...
        :rtype: :obj:`list` of :class:`Botte.types.BotCommand`
        """
    ...
    def get_my_name(self, language_code: Optional[str]=None):
        ...
        :return: :class:`Botte.types.BotName`
        """
    ...
    def get_my_description(self, language_code: Optional[str]=None):
        ...
        :return: :class:`Botte.types.BotDescription`
        """
    ...
    def get_my_short_description(self, language_code: Optional[str]=None):
        ...
        :return: :class:`Botte.types.BotShortDescription`
        """
    ...
    def set_chat_menu_button(self, chat_id: Union[int, str]=None, menu_button: types.MenuButton=None) -> bool:
        ...
        :type menu_button: :class:`Botte.types.MenuButton`
    ...
    def get_chat_menu_button(self, chat_id: Union[int, str]=None) -> types.MenuButton:
        ...
        :rtype: :class:`Botte.types.MenuButton`
        """
    ...
    def set_my_default_administrator_rights(self, rights: types.ChatAdministratorRights=None, 
        ...
        :type rights: :class:`Botte.types.ChatAdministratorRights`
    ...
    def set_my_commands(self, commands: List[types.BotCommand],
        ...
        :type commands: :obj:`list` of :class:`Botte.types.BotCommand`
    ...
    def edit_message_text(
        ...
        :type entities: List of :obj:`Botte.types.MessageEntity`
    ...
    def edit_message_media(
        ...
        :param reply_markup: A JSON-serialized object for an inline keyboard.
        :type reply_markup: :obj:`Botte.types.InlineKeyboardMarkup` or :obj:`ReplyKeyboardMarkup` or :obj:`ReplyKeyboardRemove` or :obj:`ForceReply`
    ...
    def reply_to(self, message: types.Message, text: str, **kwargs) -> types.Message:
        ...
        :param message: Instance of :class:`Botte.types.Message`
        :type message: :obj:`types.Message`

        :param text: Text of the message.
        :type text: :obj:`str`

        :param kwargs: Additional keyword arguments which are passed to :meth:`Botte.Botte.send_message`
    ...
    def get_user_chat_boosts(self, chat_id: Union[int, str], user_id: int) -> types.UserChatBoosts:
        ...
        :rtype: :class:`Botte.types.UserChatBoosts`
        """
    ...
    def get_custom_emoji_stickers(self, custom_emoji_ids: List[str]) -> List[types.Sticker]:
        ...
        :rtype: :obj:`list` of :class:`Botte.types.Sticker`
        """
    ...
    def upload_sticker_file(self, user_id: int, png_sticker: Union[Any, str]=None, sticker: Optional[types.InputFile]=None, sticker_format: Optional[str]=None) -> types.File:
        ...
        :type sticker: :class:`Botte.types.InputFile`
    ...
    def create_new_sticker_set(
        ...
        :type stickers: :obj:`list` of :class:`Botte.types.InputSticker`
    ...
    def add_sticker_to_set(
        ...
        :type sticker: :class:`Botte.types.InputSticker`
    ...
    def get_forum_topic_icon_stickers(self) -> List[types.Sticker]:
        ...
        :rtype: List[:class:`Botte.types.StickerSet`]
        """
    ...
    def answer_web_app_query(self, web_app_query_id: str, result: types.InlineQueryResultBase) -> types.SentWebAppMessage:
        ...
        :type result: :class:`Botte.types.InlineQueryResultBase`
    ...
    def register_for_reply(self, message: types.Message, callback: Callable, *args, **kwargs) -> None:
        ...
        :type callback: :obj:`Callable[[Botte.types.Message], None]`
    ...
    def setup_middleware(self, middleware: BaseMiddleware):
        ...
        :param middleware: Subclass of :class:`Botte.handler_backends.BaseMiddleware`
        :type middleware: :class:`Botte.handler_backends.BaseMiddleware`
        :return: None
        """
    ...
    def set_state(self, user_id: int, state: Union[int, str, State], chat_id: Optional[int]=None) -> None:
        ...
        :param state: new state. can be string, integer, or :class:`Botte.types.State`
        :type state: :obj:`int` or :obj:`str` or :class:`Botte.types.State`
    ...
    def get_state(self, user_id: int, chat_id: Optional[int]=None) -> Optional[Union[int, str, State]]:
        ...
        :rtype: :obj:`int` or :obj:`str` or :class:`Botte.types.State`
        """
        if chat_id is None:
            chat_id = user_id
    ...
    def add_middleware_handler(self, handler, update_types=None):
        ...
        if not apihelper.ENABLE_MIDDLEWARE:
            raise RuntimeError("Middleware is not enabled. Use apihelper.ENABLE_MIDDLEWARE before initialising Botte.")
    ...
    def handle_msg(
        ...
        As a parameter to the decorator function, it passes :class:`Botte.types.Message` object.
        All message handlers are tested in the order they were added.

        Example:

        .. code-block:: python3
            :caption: Usage of handle_msg

            bot = Botte('TOKEN')

            # Handles all messages which text matches regexp.
            @bot.handle_msg(regexp='someregexp')
            def command_help(message):
                bot.send_message(message.chat.id, 'Did someone call for help?')

            # Handles messages in private chat
            @bot.handle_msg(chat_types=['private']) # You can add more chat types
            def command_help(message):
                bot.send_message(message.chat.id, 'Private chat detected, sir!')

            # Handle all sent documents of type 'text/plain'.
            @bot.handle_msg(func=lambda message: message.document.mime_type == 'text/plain',
                content_types=['document'])
            def command_handle_document(message):
                bot.send_message(message.chat.id, 'Document received, sir!')

            # Handle all other messages.
            @bot.handle_msg(func=lambda message: True, content_types=['audio', 'photo', 'voice', 'video', 'document',
        ...
        if isinstance(content_types, str):
            logger.warning("handle_msg: 'content_types' filter should be List of strings (content types), not string.")
        ...
        def decorator(handler):
            handler_dict = self._build_handler_dict(handler,
                                                    ...
                                                    func=func,
                                                    **kwargs)
            self.add_handle_msg(handler_dict)
            return handler

        return decorator


    def add_handle_msg(self, handler_dict):
        """
        Adds a message handler
        Note that you should use register_handle_msg to add handle_msg to the bot.
        ...
        :return:
        """
        self.handle_msgs.append(handler_dict)


    def register_handle_msg(self, callback: Callable, content_types: Optional[List[str]]=None, commands: Optional[List[str]]=None,
        ...
        :param pass_bot: True if you need to pass Botte instance to handler(useful for separating handlers into different files)
        ...
        :return: None
        """
        method_name = "register_handle_msg"
        ...
        if isinstance(content_types, str):
            logger.warning("register_handle_msg: 'content_types' filter should be List of strings (content types), not string.")
            content_types = [content_types]
    ...
    def edited_handle_msg(self, commands=None, regexp=None, func=None, content_types=None, chat_types=None, **kwargs):
        """
        ...
        if isinstance(content_types, str):
            logger.warning("edited_handle_msg: 'content_types' filter should be List of strings (content types), not string.")
            content_types = [content_types]
        ...
        def decorator(handler):
            handler_dict = self._build_handler_dict(handler,
                                                    ...
                                                    func=func,
                                                    **kwargs)
            self.add_edited_handle_msg(handler_dict)
            return handler

        return decorator


    def add_edited_handle_msg(self, handler_dict):
        """
        Adds the edit message handler
        Note that you should use register_edited_handle_msg to add edited_handle_msg to the bot.
        ...
        :return:
        """
        self.edited_handle_msgs.append(handler_dict)


    def register_edited_handle_msg(self, callback: Callable, content_types: Optional[List[str]]=None,
        ...
        :return: None
        """
        method_name = "register_edited_handle_msg"
        ...
        if isinstance(content_types, str):
            logger.warning("register_edited_handle_msg: 'content_types' filter should be List of strings (content types), not string.")
            content_types = [content_types]
    ...
    def message_reaction_handler(self, func=None, **kwargs):
        ...
        As a parameter to the decorator function, it passes :class:`Botte.types.MessageReactionUpdated` object.
    ...
    def message_reaction_count_handler(self, func=None, **kwargs):
        ...
        As a parameter to the decorator function, it passes :class:`Botte.types.MessageReactionCountUpdated` object.
    ...
    def inline_handler(self, func, **kwargs):
        ...
        As a parameter to the decorator function, it passes :class:`Botte.types.InlineQuery` object.
    ...
    def chosen_inline_handler(self, func, **kwargs):
        ...
        As a parameter to the decorator function, it passes :class:`Botte.types.ChosenInlineResult` object.
    ...
    def callback_query_handler(self, func, **kwargs):
        ...
        As a parameter to the decorator function, it passes :class:`Botte.types.CallbackQuery` object.
    ...
    def shipping_query_handler(self, func, **kwargs):
        ...
        As a parameter to the decorator function, it passes :class:`Botte.types.ShippingQuery` object.
    ...
    def pre_checkout_query_handler(self, func, **kwargs):
        ...
        As a parameter to the decorator function, it passes :class:`Botte.types.PreCheckoutQuery` object.
    ...
    def poll_handler(self, func, **kwargs):
        ...
        As a parameter to the decorator function, it passes :class:`Botte.types.Poll` object.
    ...
    def poll_answer_handler(self, func=None, **kwargs):
        ...
        As a parameter to the decorator function, it passes :class:`Botte.types.PollAnswer` object.
    ...
    def my_chat_member_handler(self, func=None, **kwargs):
        ...
        As a parameter to the decorator function, it passes :class:`Botte.types.ChatMemberUpdated` object.
    ...
    def chat_join_request_handler(self, func=None, **kwargs):
        ...
        As a parameter to the decorator function, it passes :class:`Botte.types.ChatJoinRequest` object.
    ...
    def chat_boost_handler(self, func=None, **kwargs):
        ...
        it passes :class:`Botte.types.ChatBoostUpdated` object.
    ...
    def removed_chat_boost_handler(self, func=None, **kwargs):
        """
        Handles new incoming chat boost state. 
        it passes :class:`Botte.types.ChatBoostRemoved` object.
    ...
    def _test_handle_msg(self, handle_msg, message):
        """
        ...
        :return:
        """
        for message_filter, filter_value in handle_msg['filters'].items():
    ...
    def _run_middlewares_and_handler(self, message, handlers, middlewares, update_type):
        ...
        if not self.use_class_middlewares:
            if handlers:
                for handler in handlers:
                    if self._test_handle_msg(handler, message):
        ...
        if handlers and not skip_handlers:
            try:
                for handler in handlers:
                    params = []
                    process_handler = self._test_handle_msg(handler, message)
