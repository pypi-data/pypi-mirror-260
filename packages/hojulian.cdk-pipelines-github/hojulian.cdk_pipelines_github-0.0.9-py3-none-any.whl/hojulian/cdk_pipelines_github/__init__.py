...
class GitHubWorkflow(
    ...
    def __init__(
        ...
        *,
        ...
        pre_publish_steps: typing.Optional[typing.Sequence[typing.Union["JobStep", typing.Dict[builtins.str, typing.Any]]]] = None,
        ...
        :param pre_publish_steps: (experimental) Github worklow steps to execute before publish.
...
class GitHubWorkflowProps(_aws_cdk_pipelines_ceddda9d.PipelineBaseProps):
    ...
    @builtins.property
    def pre_publish_steps(self) -> typing.Optional[typing.List["JobStep"]]:
        '''(experimental) Github worklow steps to execute before publish.
