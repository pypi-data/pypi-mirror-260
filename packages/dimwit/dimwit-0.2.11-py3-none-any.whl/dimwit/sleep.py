...
def get_future_df(df):
    ...
    first_future_start = df["sleep_start"][-1] + net_delta
...
def generate_sleep_schedule_graph(df, future_df=None):
    ...
    if future_df is not None:
        ...
        not_predicted = combined_df[not combined_df["is_predicted"]]
