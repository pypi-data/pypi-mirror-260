# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/03_duck/01_lits.ipynb.
...
# %% ../../nbs/03_duck/01_lits.ipynb 6
#| export


# %% ../../nbs/03_duck/01_lits.ipynb 8
from typing import Literal, Iterable

# %% ../../nbs/03_duck/01_lits.ipynb 10
#| export


# %% ../../nbs/03_duck/01_lits.ipynb 12
from ..core.ptyp import Prototype, Opt, Not
from ..prep.matr import npbool as npb
from ..prep.matr import number, nparray
from ..prep.matr import nan as mathnan, pdna as pdNA, npnan as np_nan, npNaN, npNAN, ptnan, nparray, nonetype
from ..prep.matr import repattern, rematch as rematched, strtemplate
...
from ..prep.matr import (vidcap as cv2cv2vidcap, image as pilpilimage)
...
# %% ../../nbs/03_duck/01_lits.ipynb 14
#| export


# %% ../../nbs/03_duck/01_lits.ipynb 16
@Prototype(Iterable)
class itertype: '''iterable type'''

# %% ../../nbs/03_duck/01_lits.ipynb 20
@Prototype(npb)
...
# %% ../../nbs/03_duck/01_lits.ipynb 82
@Prototype(pdpdseries)
class pdseries:
    '''`pandas.Series`''';

# %% ../../nbs/03_duck/01_lits.ipynb 84
