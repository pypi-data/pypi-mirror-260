# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/00_util/02_prot.ipynb.

# %% auto 0
__all__ = ['ProtocolMeta', 'GuardProtocol', 'NotProtocol', 'OptProtocol', 'Hashable', 'Origin', 'Special', 'NotSpecial',
           'NonStrBytesIterable', 'PrivateString', 'DunderString', 'HasAnyAttributeProtocol', 'HasAllAttributeProtocol',
           'DuckedProtocol', 'DuckSpecProtocol', 'DuckModuleProtocol']

# %% ../../nbs/00_util/02_prot.ipynb 6
#| export


# %% ../../nbs/00_util/02_prot.ipynb 8
from types import NoneType
from typing import (Any, Self, TypeGuard, Protocol, Iterable, _SpecialForm, _ProtocolMeta, Generic, get_origin,)

# %% ../../nbs/00_util/02_prot.ipynb 10
#| export

# %% ../../nbs/00_util/02_prot.ipynb 12
#| export

# %% ../../nbs/00_util/02_prot.ipynb 14
from .cons import U1, U2, DUCK_SPEC_ATTRS, DUCKED_ATTRS, __HASH__, __ATTRS__
from .type import T

# %% ../../nbs/00_util/02_prot.ipynb 16
...
# %% ../../nbs/00_util/02_prot.ipynb 28
class PrivateString(GuardProtocol[T]):
    @classmethod
    def __guard__(self: Self, ins) -> TypeGuard[T]:
        return str(ins).startswith(U1)
    
class DunderString(GuardProtocol[T]):
    @classmethod
    def __guard__(self: Self, ins) -> TypeGuard[T]:
        return str(ins).startswith(U2) and str(ins).endswith(U2)

# %% ../../nbs/00_util/02_prot.ipynb 30
