# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/01_core/15_base.ipynb.

# %% auto 0
__all__ = ['Duck', 'DuckModule', 'DuckSpec']

# %% ../../nbs/01_core/15_base.ipynb 6
import sys

# %% ../../nbs/01_core/15_base.ipynb 8
from types import ModuleType, FunctionType, BuiltinFunctionType
from typing import Any, Self, Union, Callable, Optional

# %% ../../nbs/01_core/15_base.ipynb 10
#| export

# %% ../../nbs/01_core/15_base.ipynb 12
#| export

# %% ../../nbs/01_core/15_base.ipynb 14
from ..util.cons import NIL, DUCKSPEC, ASSET, _DUCK, DUCK_SPEC_ATTRS
from ..util.type import P
from ..util.misc import (prep_kwargs, asset_last, tryattr)
from .meta import DuckModuleMeta, ABCDuck

# %% ../../nbs/01_core/15_base.ipynb 17
class Duck(metaclass=ABCDuck):
    '''A class representing a duck-type.'''
    

# %% ../../nbs/01_core/15_base.ipynb 23
class DuckModule(ModuleType, metaclass=DuckModuleMeta):
    ...

# %% ../../nbs/01_core/15_base.ipynb 31
