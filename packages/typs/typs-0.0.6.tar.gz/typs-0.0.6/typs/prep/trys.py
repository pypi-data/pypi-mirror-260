# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/02_prep/00_trys.ipynb.

# %% auto 0
__all__ = ['repattern', 'rematch', 'strtemplate', 'nan', 'number', 'logger', 'pathlike', 'sig', 'param', 'ichain', 'iprod',
           'ziplong', 'dict_keys', 'dict_values', 'dict_items', 'moduletype', 'wrappertype', 'builtinfunctype',
           'nonetype', 'trackbacktype', 'functiontype', 'mapping', 'iterable', 'np', 'npdatasource', 'npbool',
           'npmatrix', 'nparray', 'recarray', 'npempty', 'npnan', 'npNaN', 'npNAN', 'earray', 'pd', 'pdna', 'pdindex',
           'pdseries', 'pdcatindex', 'pddataframe', 'pddelegate', 'sp', 'sparray', 'spmatrix', 'splinalg', 'speigs',
           'sppdist', 'cscarray', 'cscmatrix', 'csrarray', 'csrmatrix', 'cooarray', 'coomatrix', 'dokarray',
           'dokmatrix', 'diaarray', 'diamatrix', 'lilarray', 'lilmatrix', 'bsrarray', 'bsrmatrix', 'ptnan', 'ptsize',
...
# %% ../../nbs/02_prep/00_trys.ipynb 5
#| export


# %% ../../nbs/02_prep/00_trys.ipynb 7
from types import ModuleType, FunctionType
from typing import TypeAlias
try: from abc import ABCMeta
except ImportError:  ABCMeta = type

# %% ../../nbs/02_prep/00_trys.ipynb 9
from ..util.imps import imod, itry

# %% ../../nbs/02_prep/00_trys.ipynb 12
repattern: type = imod('re', 'Pattern')
rematch: type = imod('re', 'Match')
...
# %% ../../nbs/02_prep/00_trys.ipynb 34
vidcap, = itry('cv2', 'VideoCapture')
vidcap: type

# %% ../../nbs/02_prep/00_trys.ipynb 36
image, = itry('PIL.Image', 'Image')
image: type

# %% ../../nbs/02_prep/00_trys.ipynb 38
anndata, = itry('anndata', 'AnnData')
AnnData, = itry('anndata', 'AnnData')
anndata: type
AnnData: type

# %% ../../nbs/02_prep/00_trys.ipynb 40
...
# %% ../../nbs/02_prep/00_trys.ipynb 42
sns: ModuleType = imod('seaborn')

# %% ../../nbs/02_prep/00_trys.ipynb 44
...
# %% ../../nbs/02_prep/00_trys.ipynb 46
PHATE, = itry('phate', 'PHATE', bases=(skestimator, ))
PHATE: type

# %% ../../nbs/02_prep/00_trys.ipynb 48
