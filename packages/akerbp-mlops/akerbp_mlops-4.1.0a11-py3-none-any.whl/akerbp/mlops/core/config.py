    ...
    for setting in settings:
        ...
        if valid_metadata:
            ...
            if len(missing_fields) > 0:
                ...
                error_message = "Too many fields in the metadata specification. Make sure to stay within the limitations of 32 fields and 512 characters per field."
                raise TooMuchMetadataFieldsError(error_message)
...
def metadata_validation(settings: dict) -> Tuple[bool, List[str]]:
    ...
    valid_metadata = True
    if len(metadata_fields) > 16:
        logger.warning(
            "Too many fields in the metadata specification, exceeding the maximum of 16 fields."
        )
    ...
    if len(missing_fields) == 0 and valid_metadata:
