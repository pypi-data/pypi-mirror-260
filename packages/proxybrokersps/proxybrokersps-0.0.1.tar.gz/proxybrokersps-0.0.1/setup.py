...
PACKAGES = ['proxybrokersps', 'proxybrokersps.data']
...
setup(
    ...
    entry_points={'console_scripts': ['proxybrokersps = proxybrokersps.cli:cli']},
    classifiers=[
