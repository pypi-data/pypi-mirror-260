...
class PartitionDataMeta(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        partition_id : typing.Text = ...,
        segment_num : builtins.int = ...,
        segment_data : typing.Optional[typing.Iterable[global___SegmentDataMeta]] = ...,
        ) -> None: ...
...
class DataMeta(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        secret_shard_num : builtins.int = ...,
        version : builtins.int = ...,
        partition_data : typing.Optional[typing.Iterable[global___PartitionDataMeta]] = ...,
        ancestors : typing.Optional[typing.Iterable[global___Ancestor]] = ...,
        all_ancestors : typing.Optional[typing.Iterable[global___Ancestor]] = ...,
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["optional_schema",b"optional_schema"]) -> typing.Optional[typing_extensions.Literal["schema"]]: ...
...
class SegmentDataUri(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        status : typing.Text = ...,
        mac : builtins.bytes = ...,
        segment_data_meta : typing.Optional[global___SegmentDataMeta] = ...,
        data_key : builtins.bytes = ...,
        ) -> None: ...
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["optional_seg",b"optional_seg"]) -> typing.Optional[typing_extensions.Literal["segment_data_meta","data_key"]]: ...
...
class PartitionDataUri(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        partition_id : typing.Text = ...,
        seg_data_uris : typing.Optional[typing.Iterable[global___SegmentDataUri]] = ...,
        ) -> None: ...
...
class DataUri(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        data_uuid : typing.Text = ...,
        part_data_uris : typing.Optional[typing.Iterable[global___PartitionDataUri]] = ...,
        ) -> None: ...
...
class EnclaveInfo(google.protobuf.message.Message):
    ...
    hex_mrenclave: typing.Text = ...
    hex_mrsigner: typing.Text = ...
    hex_prod_id: typing.Text = ...
...
class DataAuth(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        ...
        allowed_apps : typing.Optional[typing.Iterable[global___EnclaveInfo]] = ...,
...
class DataAccessToken(google.protobuf.message.Message):
    ...
    def __init__(self,
        *,
        storage_type : typing.Text = ...,
        access_info : typing.Optional[google.protobuf.any_pb2.Any] = ...,
        expiration : typing.Text = ...,
        ) -> None: ...
...
class OssInfo(google.protobuf.message.Message):
    ...
    bucket: typing.Text = ...
    sts_access_key_id: typing.Text = ...
    """temporary credential for accessing oss"""

    sts_access_key_secret: typing.Text = ...
    sts_security_token: typing.Text = ...
    def __init__(self,
        *,
        endpoint : typing.Text = ...,
        bucket : typing.Text = ...,
