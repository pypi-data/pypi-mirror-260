...
class CV:
    ...
    def __init__(
        ...
        logo_pied="file_static/logo_pied.png",
    ) -> None:
    ...
    def to_pdf_file(self, output_pdf_file, css_lien):
        ...
        html = HTML(
            string=self.to_html_content(css_lien, for_pdf=True), base_url=""
        )  # noqa:
