...
project = u'Moving Targets'
copyright = u'2021, University of Bologna - DISI'
...
htmlhelp_basename = 'MovingTargetsDoc'
...
latex_documents = [
    (master_doc, 'MovingTargets.tex', u'Moving Targets Documentation', u'University of Bologna - DISI', 'manual'),
]
...
man_pages = [(master_doc, 'movingtargets', u'Moving Targets Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'MovingTargets', u'Moving Targets Documentation', author,
     'Moving Targets', 'One line description of project.', 'Miscellaneous'),
]
