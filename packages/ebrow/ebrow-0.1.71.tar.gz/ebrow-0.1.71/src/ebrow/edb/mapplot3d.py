...
class MapPlot3D(BaseGraph):
    def __init__(self, dfMap: pd.DataFrame, dfPower: pd.DataFrame, settings: Settings, inchWidth: float,
        ...
        self._ax3d.set_facecolor(backColor)
        self._ax3d.xaxis.pane.set_edgecolor(backColor)
        self._ax3d.yaxis.pane.set_edgecolor(backColor)
        self._ax3d.zaxis.pane.set_edgecolor(backColor)
