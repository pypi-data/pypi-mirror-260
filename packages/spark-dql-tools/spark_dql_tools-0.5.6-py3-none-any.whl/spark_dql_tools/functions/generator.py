...
def dq_generated_dataframe_json(hamu_type=None,
    ...
    if hamu_type == "staging":
        ...
        repo_config = os.path.join(repo_path_per_staging, uuaa_master, "staging", table_master_name, repo_version, f"{table_master_name}-01.conf")
    ...
    if hamu_type == "raw":
        ...
        table_dict["kind"] = "processing"
        table_dict["params"] = dict()
        repo_config = os.path.join(repo_path_per_raw, uuaa_master, "raw", table_master_name, repo_version, f"{table_master_name}-01.conf")
        table_dict["params"]["configUrl"] = repo_config
        table_dict["params"]["sparkHistoryEnabled"] = "false"
        table_dict["runtime"] = "hammurabi-lts"
        table_dict["size"] = "M"
    ...
    if hamu_type == "master":
        ...
        table_dict["kind"] = "processing"
        table_dict["params"] = dict()
        repo_config = os.path.join(repo_path_per_master, uuaa_master, "master", table_master_name, repo_version, f"{table_master_name}-01.conf")
        table_dict["params"]["configUrl"] = repo_config
        table_dict["params"]["sparkHistoryEnabled"] = "false"
        table_dict["runtime"] = "hammurabi-lts"
        table_dict["size"] = "M"
