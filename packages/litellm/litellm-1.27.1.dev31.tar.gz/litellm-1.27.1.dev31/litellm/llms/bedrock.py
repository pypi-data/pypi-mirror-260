...
def _set_env_vars_based_on_arn(aws_arn_arguments):
    ...
    verbose_logger.debug(f"non assumed role {non_used_assumed_role}")
    verbose_logger.debug(f"making call2 with args {aws_arn_arguments}")
    ...
    verbose_logger.debug(f"result call2 assumed role {assumed_role}")
