...
class BaseManager:
    ...
    def previous_version(self, obj: 'Model') -> Optional['Model']:
        ...
        return self._get_specific_version(object_id, object_version)
    ...
    def _get_specific_version(self, object_id: str, object_version: str | None) -> Optional['Model']:
        ...
        return (
            ...
            .get(_address__object_id=object_id, _address__version=object_version)
            .execute()
        )
