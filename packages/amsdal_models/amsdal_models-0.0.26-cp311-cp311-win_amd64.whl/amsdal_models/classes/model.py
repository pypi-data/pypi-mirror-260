...
class Model(TypeModel, metaclass=AmsdalModelMetaclass):
    ...
    @transaction
    def save(self, *, force_insert: bool = False, using: str | None = None, skip_hooks: bool = False) -> 'Model':
        """
    ...
    def previous_version(self) -> Optional['Model']:
        """
    ...
    def next_version(self) -> Optional['Model']:
        """
