...
class vxWeChatBot:
    ...
    def send_text(
        ...
        return self.__executor__.submit(self.send_message, msgs)

    def send_markdown(self, content: str) -> Future[bool]:
        """发送markdown消息"""
        msgs = {
            "msgtype": "markdown",
    ...
    def send_news(self, *articles: Collection[str]) -> Future[bool]:
        """发送图文消息"""
        msgs = {
            "msgtype": "news",
    ...
    def send_notice(self, **content: Dict[str, Collection[str]]) -> Future[bool]:
        """发送模板消息"""
        msgs = {
