...
def objective_function(
    ...
    min_cluster_size = trial.suggest_int('min_cluster_size', 2, data.shape[0]-1)
    min_samples = trial.suggest_int('min_samples', 1, data.shape[0]-1)
    alpha = trial.suggest_float('alpha', 0.0, 2.0)
    n_neighbors = trial.suggest_int('n_neighbors', 2, data.shape[0]-1)
