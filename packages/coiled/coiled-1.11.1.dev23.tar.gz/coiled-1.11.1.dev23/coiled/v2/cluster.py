    ...
    async def _wait_for_custom_certificate(
        ...
        with live:
            ...
            while True:
                ...
                cert_status = await self.cloud._check_custom_certificate(subdomain=subdomain, account=account)
            ...
            if should_try_create:
                ...
                if self.dashboard_custom_subdomain:
                    ...
                    await cloud._create_custom_certificate(
                        account=self.account, subdomain=self.dashboard_custom_subdomain
                    )
