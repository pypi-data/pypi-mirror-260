...
- 0.8.90
    ...
    - Bug Update - Redhat 8 issue with Feb 2024 sqlite update.  Added additional integrity checks added to ensure database file is valid after upgrade to sqlite3 libraries.
- 0.8.85
...
0.8.90 | 2024-03-05 10:00 ET | Minor Update - Added ability to present payload options to etl_asset_inventory through etld_config_settings.yaml.
0.8.90 | 2024-03-05 10:00 ET | Bug Update - Redhat 8 issue with Feb 2024 sqlite update.  Added additional integrity checks added to ensure database file is valid after upgrade to sqlite3 libraries.
```
