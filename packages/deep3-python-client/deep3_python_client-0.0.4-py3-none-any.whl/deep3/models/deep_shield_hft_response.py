...
class DeepShieldHftResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeepShieldHftResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeepShieldHftResponse:
        """Create an instance of DeepShieldHftResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeepShieldHftResponse.parse_obj(obj)

        _obj = DeepShieldHftResponse.parse_obj({
            "code": obj.get("code"),
