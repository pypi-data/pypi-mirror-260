...
class GetStakeSageLResponse(BaseModel):
    """
    GetStakeSageLResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetStakeSageLResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetStakeSageLResponse:
        """Create an instance of GetStakeSageLResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetStakeSageLResponse.parse_obj(obj)

        _obj = GetStakeSageLResponse.parse_obj({
            "code": obj.get("code"),
