...
class PostHodlC1XTokenResponse(BaseModel):
    """
    PostHodlC1XTokenResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PostHodlC1XTokenResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PostHodlC1XTokenResponse:
        """Create an instance of PostHodlC1XTokenResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PostHodlC1XTokenResponse.parse_obj(obj)

        _obj = PostHodlC1XTokenResponse.parse_obj({
            "code": obj.get("code"),
