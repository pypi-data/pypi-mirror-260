...
class GetStakeSageHResponse(BaseModel):
    """
    GetStakeSageHResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetStakeSageHResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetStakeSageHResponse:
        """Create an instance of GetStakeSageHResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetStakeSageHResponse.parse_obj(obj)

        _obj = GetStakeSageHResponse.parse_obj({
            "code": obj.get("code"),
