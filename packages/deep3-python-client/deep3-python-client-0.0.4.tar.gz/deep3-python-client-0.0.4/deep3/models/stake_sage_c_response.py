...
class StakeSageCResponse(BaseModel):
    """
    StakeSageCResponse
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StakeSageCResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StakeSageCResponse:
        """Create an instance of StakeSageCResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StakeSageCResponse.parse_obj(obj)

        _obj = StakeSageCResponse.parse_obj({
            "code": obj.get("code"),
