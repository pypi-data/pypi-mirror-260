    ...
    def get_environment_json_path(
        ...
        with tracer.start_as_current_span("get_environment_paths"):
            try:
                ...
                data_product_individual_id = data_product_id.replace(f"{data_product_id_root}_","")
                env_folder_path = f"{repository_path.rstrip('/')}/{data_product_id_root}/{data_product_individual_id}/"
