...
from helpers import get_test_for_test_run_id, get_test_name_for_test_run_id, group_by_data_point_id, pick_matching_keys_from_dict
        ...
        try:
            return render_template('index.html',
                                   target_results=json.dumps(
                                       group_by_data_point_id(target_results)),
                                   total_elements=len(target_results),
                                   total_pages=total_pages,
                                   current_page=page,
                                   uniq_tests=groups,
                                   count_of_key=count_of_key_creator(
                                       'is_passed'),
