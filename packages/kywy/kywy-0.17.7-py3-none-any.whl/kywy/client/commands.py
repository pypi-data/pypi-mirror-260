...
class KawaCommands:
    ...
    def replace_datasource_primary_keys(self, datasource, new_primary_keys, partition_key=None):
    ...
    def set_python_private_join_script(self, python_private_join_entity_id, script_content, script_name):
        return self._run_command(command_name='SetPythonPrivateJoinScript',
                                 command_parameters={
                                     'pythonPrivateJoinId': python_private_join_entity_id,
    ...
    def set_python_private_join_mapping(self, python_private_join_entity_id, param_mapping):
        return self._run_command(command_name='SetPythonPrivateJoinMapping',
                                 command_parameters={
                                     'pythonPrivateJoinId': python_private_join_entity_id,
                                     'paramMapping': param_mapping
                                 })
