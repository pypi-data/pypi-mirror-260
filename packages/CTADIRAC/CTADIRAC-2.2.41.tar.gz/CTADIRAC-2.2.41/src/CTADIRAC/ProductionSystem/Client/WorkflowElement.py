...
class WorkflowElementDefinition:
    ...
    def __init__(self, we_type: str) -> None:
        self.allowed_simulation_types: list[str] = WorkflowElementTypes.allowed_simulation_types
        self.allowed_processing_types: list[str] = WorkflowElementTypes.allowed_processing_types
...
class WorkflowElement(WorkflowElementDefinition):
    ...
    def set_constrained_mc_job_attribute(self, key, value) -> None:
        ...
        if key == "catalogs":
            ...
            if "-sc" not in str(value):  # if the version has not already been set by 'sct'
