...
def create(
        ...
        name: Annotated[str, typer.Option("--name", "-n", help="The name of the mod",
                                          prompt="Mod Name", rich_help_panel="Basic Info")],
        creator: Annotated[str, typer.Option("--creator", "-c", help="The creator of the mod",
                                             prompt=True, rich_help_panel="Basic Info")],
        slug: Annotated[str, typer.Option("--slug", "-s",
                                          help="The slug of the mod (terminal-friendly name)",
                                          default_factory=slug_factory, rich_help_panel="Advanced Options")],
        version: Annotated[str, typer.Option("--version", "-v", help="The version of the mod",
                                             rich_help_panel="Detailed Info")] = "0.1.0",
        description: Annotated[str, typer.Option("--description", "-d",
                                                 help="The description of the mod",
                                                 rich_help_panel="Detailed Info")] = "A DnDG Mod",
