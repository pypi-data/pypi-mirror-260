...
const ENTRY_CSS = "./assets/index-33179a8d.css";
let FONTS;
FONTS = [];
let IndexComponent;
let _res;
...
async function get_index() {
  IndexComponent = (await __vitePreload(() => import('./Index-e8ffd830.js').then(n => n.I),true?["./Index-e8ffd830.js","./Index-671788bd.css"]:void 0,import.meta.url)).default;
  _res();
}
...
//# sourceMappingURL=index-dc71b4a2.js.map
