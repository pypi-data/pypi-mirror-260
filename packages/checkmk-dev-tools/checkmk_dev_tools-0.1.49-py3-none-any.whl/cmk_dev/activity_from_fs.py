...
class Day:
    ...
    class ColorBox:
        ...
        def __init__(self, minutes: Mapping[int, Set[Path]]) -> None:
            self.minutes = minutes

        def __rich_console__(self, _console: Console, options: ConsoleOptions) -> RenderResult:
            box_width = options.max_width - 30
            ...
            for x in range(box_width):
                ...
                intensity = min(255, count and (count + 50))
    ...
    def activity_bar(self) -> RenderableType:
        """Returns a drawable bar representing a day"""
        return self.ColorBox(self.minutes)
