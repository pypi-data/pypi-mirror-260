...
def assd(result, reference, voxelspacing=None, connectivity=1):
    ...
    """
    assd = numpy.mean( (__surface_distances(result, reference, voxelspacing, connectivity).mean(), __surface_distances(reference, result, voxelspacing, connectivity).mean()) )
    return assd
