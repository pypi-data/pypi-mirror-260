...
class DumpYaml:
    ...
    #                 # Handle nested structure based on config_mode
    ...
    #     # Specific handling for 'pipelines'
    #     if object_type == "pipelines" and 'launch' in json_data:
    ...
    #     # Append transformed launch data
    #     ordered_env.extend(transformed_nested.items())
