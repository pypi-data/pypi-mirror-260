...
#     @profile
    def data_split(self):
        ...
        """
        print("Start spliting the dataset.")
        if self.shuffle == 1:
        ...
        self.obs = pd.DataFrame(self.obs[:, 0:], columns=self.obs.columns[0:])
        self.var = snap_adata.var[:]
        self.var = pd.DataFrame(self.var[:, 0:], columns=self.var.columns[0:])
        origin_sum = 0
...
#     @profile
    def metacell_preprocess(self,
        ...
        print("Start preprocessing of metacells.")
...
#         self.mc_adata.write(self.carousel_preprocessed_dir + '/%s_carousel_pped.h5ad' % self.data_name)
        print(self.mc_adata)
        print("Finish preprocessing of metacells.")
...
#     @profile
    def result_comparison(self):
        ...
        cluster_index = ['AMI_Dlouvain', 'ARI_Dlouvain', 'NMI_Dlouvain', 'Homo_Dlouvain', 'CS_Dlouvain',
                         'FMI_Dlouvain',
                         'AMI_Dleiden', 'ARI_Dleiden', 'NMI_Dleiden', 'Homo_Dleiden', 'CS_Dleiden',
                         'FMI_Dleiden',
                         'AMI_Clouvain', 'ARI_Clouvain', 'NMI_Clouvain', 'Homo_Clouvain', 'CS_Clouvain',
                         'FMI_Clouvain',
                         'AMI_Cleiden', 'ARI_Cleiden', 'NMI_Cleiden', 'Homo_Cleiden', 'CS_Cleiden',
                         'FMI_Cleiden',
