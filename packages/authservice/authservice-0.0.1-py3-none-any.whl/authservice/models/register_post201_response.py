...
class RegisterPost201Response(BaseModel):
    """
    RegisterPost201Response
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="Success message")
    client_id: Optional[StrictStr] = Field(default=None, description="Generated client ID", alias="clientId")
    client_secret: Optional[StrictStr] = Field(default=None, description="Generated client secret", alias="clientSecret")
