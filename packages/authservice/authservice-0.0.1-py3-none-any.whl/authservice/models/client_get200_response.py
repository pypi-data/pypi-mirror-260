...
class ClientGet200Response(BaseModel):
    """
    ClientGet200Response
    """ # noqa: E501
    client_id: Optional[StrictStr] = Field(default=None, description="User's client ID", alias="clientId")
    client_secret: Optional[StrictStr] = Field(default=None, description="User's client secret", alias="clientSecret")
