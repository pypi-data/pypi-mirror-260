...
class RegenerateClientCredentialsPost200Response(BaseModel):
    """
    RegenerateClientCredentialsPost200Response
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="Success message")
    client_id: Optional[StrictStr] = Field(default=None, description="New client ID", alias="clientId")
    client_secret: Optional[StrictStr] = Field(default=None, description="New client secret", alias="clientSecret")
    __properties: ClassVar[List[str]] = ["message", "clientId", "clientSecret"]
