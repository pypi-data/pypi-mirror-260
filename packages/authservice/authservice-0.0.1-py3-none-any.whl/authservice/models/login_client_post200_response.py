...
class LoginClientPost200Response(BaseModel):
    """
    LoginClientPost200Response
    """ # noqa: E501
    token: Optional[StrictStr] = Field(default=None, description="JWT token")
    token_type: Optional[StrictStr] = Field(default=None, description="Type of token")
    expires_in: Optional[StrictInt] = Field(default=None, description="Expiry time of token in seconds")
