# -*- coding: utf-8 -*-
"""Installer for the collective.manifestjson package."""
...
setup(
    ...
    url="https://github.com/collective/collective.manifestjson",
    project_urls={
        ...
        # 'Documentation': 'https://collective.manifestjson.readthedocs.io/en/latest/',
    },
    ...
    target = plone
    [console_scripts]
    update_locale = collective.manifestjson.locales.update:update_locale
    """,
)
