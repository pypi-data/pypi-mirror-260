...
class Mutation(sgqlc.types.Type):
    ...
    trigger_subscription_billing_month_ends_soon_webhook = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='triggerSubscriptionBillingMonthEndsSoonWebhook', args=sgqlc.types.ArgDict((
