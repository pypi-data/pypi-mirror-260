...
if __name__ == '__main__':
    ...
    #st=stratage_timing()
    # st.market_liquidity('20070101','20231231')
    # st.market_style_distinguish('20070101','20231231')
    # st.market_states_distinguish('20070101','20231231')
    # st.marco_eco_states_distinguish('2007-01-01','2023-12-31')
    # st.currency_states_distinguish('2007-12-01', '2023-12-31')
    # st.industry_states_distinguish('20070101','20240126')
