...
def get_super_asset_index_stats(latest_holding,latest_date):
    ...
    ['FOF：进攻性资产', 'FOF：CTA', 'FOF：稳健性资产','FOF：公募偏股','FOF：量化多头','FOF：主观多头']] = fof_annually_ret.values.tolist()
    ...
    ['FOF：进攻性资产', 'FOF：CTA', 'FOF：稳健性资产','FOF：公募偏股','FOF：量化多头','FOF：主观多头']] = fof_vol.values.tolist()
    asset_VAR.loc[asset_VAR.index[-1],
    ['FOF：进攻性资产', 'FOF：CTA', 'FOF：稳健性资产','FOF：公募偏股','FOF：量化多头','FOF：主观多头']] = fof_VAR.values.tolist()
