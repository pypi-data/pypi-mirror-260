...
if __name__ == '__main__':
    ...
    save_nav_based_result_history2db('20240101','20240222')
    save_holding_based_result_history2db('20231101', '20240222')
    #save_prvfund_nav_based_result_history2db('20230630', '20240131')
