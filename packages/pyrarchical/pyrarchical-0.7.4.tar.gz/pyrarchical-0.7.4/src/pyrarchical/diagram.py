...
if __name__ == "__main__":
    ...
    state_machine.generate_plant_uml(filename="examples/cd_player.txt")
    ...
    # default plantUML output
    state_machine.generate_plant_uml(filename="examples/canonical.txt")
    ...
    # default plantUML output
    state_machine.generate_plant_uml(filename="examples/orthogonal.txt")
