...
class AlgoWorldMapDef:
    ...
    def _parse(
        ...
        if line.startswith("map:"):
            self._parse_def("map", AlgoWorldMapDef.Size)
            self._validate_size_def()
            return
        if line.startswith("tile:"):
            self._parse_def("tile", AlgoWorldMapDef.Tile)
