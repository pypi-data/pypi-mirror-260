...
class Canvas(tk.Canvas):
    ...
    def _draw_cell(self, tile, shift_x, shift_y):
        ...
        rect = [shift_x, shift_y, shift_x + self.cell_size, shift_y + self.cell_size]
    ...
    def _draw_robot(self, r: Robot):
        ...
        fill = r.color
        tag = (r.name,)
        coords = [0.4, 0, 0, 0.4, 0.4, 0.8, 0.8, 0.4]
        ...
        self.move(r.name, self.cell_size * 0.1, self.cell_size * 0.1)
