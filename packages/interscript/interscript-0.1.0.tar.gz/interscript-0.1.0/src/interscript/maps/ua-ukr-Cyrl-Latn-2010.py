...
def _stage_main(s):
    ...
    s = re.compile("’", re.MULTILINE).sub("", s)
    s = interscript.stdlib.parallel_replace_tree(s, _PTREE_1029895533576573569)
...
_PTREE_1029895533576573569 = {1168:{None:"G"},1169:{None:"g"},1065:{None:"Shch"},1097:{None:"shch"},1100:{None:""},1068:{None:""},39:{None:""},8217:{None:""}}
