...
def _stage_translit(s):
    ...
    s = re.compile("[’Ъъ]я", re.MULTILINE).sub("ja", s)
    s = interscript.stdlib.parallel_replace_tree(s, _PTREE_4421870383515648665)
    return s
