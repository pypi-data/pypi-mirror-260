...
def _stage_main(s):
    ...
    s = re.compile("(?<=[АаЕеЁёИиОоУуЭэЮюЯяЙйЬь])е", re.MULTILINE).sub("ye", s)
    s = interscript.stdlib.parallel_replace_tree(s, _PTREE_3209003026281786563)
...
_PTREE_3209003026281786563 = {1042:{None:"V"},1170:{None:"G‘"},1046:{None:"J"},1038:{None:"O‘"},1061:{None:"X"},1066:{None:"’"},1068:{None:"’"},1074:{None:"w"},1171:{None:"g‘"},1078:{None:"j"},1118:{None:"o‘"},1093:{None:"x"},1098:{None:"’"},1100:{None:"’"}}
