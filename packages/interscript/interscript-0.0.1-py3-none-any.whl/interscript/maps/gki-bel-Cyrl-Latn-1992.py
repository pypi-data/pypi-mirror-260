...
def _stage_main(s):
    s = interscript.stdlib.parallel_replace_tree(s, _PTREE_872278981402676294)
...
_PTREE_872278981402676294 = {1030:{None:"I"},1110:{None:"i"},1043:{None:"G"},1075:{None:"g"},1038:{None:"Ŭ"},1118:{None:"ŭ"},1070:{None:"Ju"},1102:{None:"ju"},1071:{None:"Ja"},1103:{None:"ja"}}
