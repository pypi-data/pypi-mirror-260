...
def _stage_main(s):
    ...
    s = interscript.stdlib.parallel_replace_tree(s, _PTREE_1975974894566551366)
    return s

interscript.stdlib.add_map_stage("alalc-rus-Cyrl-Latn-2012", "main", _stage_main)
_PTREE_1975974894566551366 = {1030:{None:"Ī"},1110:{None:"ī"},1122:{None:"I͡E"},1123:{None:"i͡e"},1138:{None:"Ḟ"},1139:{None:"ḟ"},1140:{None:"Ẏ"},1141:{None:"ẏ"}}
