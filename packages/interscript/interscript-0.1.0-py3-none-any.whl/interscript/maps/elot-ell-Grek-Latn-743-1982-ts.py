...
def _stage_main(s):
    ...
    s = re.compile(";", re.MULTILINE).sub("?", s)
    s = interscript.stdlib.parallel_replace_tree(s, _PTREE_744367436898912281)
...
_PTREE_744367436898912281 = {39:{None:""},902:{None:"Á"},913:{None:"A"},914:{None:"V"},915:{None:"G"},916:{None:"D"},917:{None:"E",938:{None:"Eï"},970:{None:"Eï"}},904:{970:{None:"Éï"},None:"É"},918:{None:"Z"},919:{None:"I"},920:{None:"Th"},921:{None:"I"},922:{None:"K"},923:{None:"L"},924:{None:"M"},925:{None:"N"},926:{None:"X"},927:{None:"O"},928:{None:"P"},929:{None:"R"},931:{None:"S"},932:{None:"T"},933:{None:"Y"},934:{None:"F"},935:{None:"Ch"},936:{None:"Ps"},937:{None:"O"},905:{None:"Í"},906:{None:"Í"},908:{None:"Ó"},910:{None:"Ý"},911:{None:"Ó"},938:{None:"Ï"},939:{None:"Ÿ"},940:{None:"á"},945:{None:"a"},946:{None:"v"},947:{None:"g"},948:{None:"d"},949:{None:"e",970:{None:"eï"}},941:{970:{None:"éï"},953:{None:"éi"},None:"é"},950:{None:"z"},951:{None:"i"},952:{None:"th"},953:{None:"i"},954:{None:"k"},955:{None:"l"},956:{None:"m"},957:{None:"n"},958:{None:"x"},959:{None:"o"},960:{None:"p"},961:{None:"r"},963:{None:"s"},962:{None:"s"},964:{None:"t"},965:{None:"y"},966:{None:"f"},967:{None:"ch"},968:{None:"ps"},969:{None:"o"},942:{None:"í"},943:{None:"í"},972:{None:"ó"},973:{None:"ý"},974:{None:"ó"},970:{None:"ï"},971:{None:"ÿ"},912:{None:"ḯ"},944:{None:"ÿ́"},903:{None:";"},183:{None:";"}}
