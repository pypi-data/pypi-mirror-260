...
interscript.stdlib.define_map("alalc-srp-Cyrl-Latn-1997")
def _stage_main(s):
    s = interscript.stdlib.parallel_replace_tree(s, _PTREE_4518883074354497784)
