...
def _stage_main(s):
    ...
    s = re.compile("ь", re.MULTILINE).sub("y", s)
    s = re.compile("ъ", re.MULTILINE).sub("a", s)
    s = interscript.stdlib.parallel_replace_tree(s, _PTREE_3663873193386724465)
...
_PTREE_3663873193386724465 = {1096:{None:"sh",1096:{None:"sh",1096:{None:"sh",1096:{None:"sh",1096:{None:"sh",1096:{None:"sh"}}}}}},1095:{None:"ch",1095:{None:"ch",1095:{None:"ch",1095:{None:"ch",1095:{None:"ch",1095:{None:"ch"}}}}}}}
