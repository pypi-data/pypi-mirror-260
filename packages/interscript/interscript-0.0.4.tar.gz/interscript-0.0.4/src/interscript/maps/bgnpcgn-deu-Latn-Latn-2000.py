...
def _stage_main(s):
    ...
    s = interscript.stdlib.parallel_replace_tree(s, _PTREE_4130190717478528398)
    return s

interscript.stdlib.add_map_stage("bgnpcgn-deu-Latn-Latn-2000", "main", _stage_main)
_PTREE_4130190717478528398 = {196:{None:"Ae"},214:{None:"Oe"},220:{None:"Ue"},228:{None:"ae"},246:{None:"oe"},252:{None:"ue"},946:{None:"ss"}}
