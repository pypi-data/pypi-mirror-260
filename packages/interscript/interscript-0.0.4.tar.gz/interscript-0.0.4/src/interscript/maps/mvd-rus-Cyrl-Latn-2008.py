...
def _stage_translit(s):
    ...
    s = re.compile("[’Ъъ]я", re.MULTILINE).sub("ja", s)
    s = interscript.stdlib.parallel_replace_tree(s, _PTREE_3644240304310775256)
    return s
