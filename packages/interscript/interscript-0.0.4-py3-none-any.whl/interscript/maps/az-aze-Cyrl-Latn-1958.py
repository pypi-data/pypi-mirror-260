...
def _stage_main(s):
    ...
    s = interscript.stdlib.parallel_replace_tree(s, _PTREE_2859226119495007239)
    return s

interscript.stdlib.add_map_stage("az-aze-Cyrl-Latn-1958", "main", _stage_main)
_PTREE_2859226119495007239 = {1032:{None:"Y"},1049:{None:"J"},1062:{None:""},1069:{None:""},1070:{None:""},1071:{None:""},1112:{None:"y"},1081:{None:"j"},1094:{None:""},1101:{None:""},1102:{None:""},1103:{None:""}}
