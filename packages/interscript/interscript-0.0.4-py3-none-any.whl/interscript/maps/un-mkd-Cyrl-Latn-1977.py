...
def _stage_main(s):
    ...
    s = re.compile("ќ(?=[ЕИеи])", re.MULTILINE).sub("k", s)
    s = interscript.stdlib.parallel_replace_tree(s, _PTREE_1921800000017077031)
