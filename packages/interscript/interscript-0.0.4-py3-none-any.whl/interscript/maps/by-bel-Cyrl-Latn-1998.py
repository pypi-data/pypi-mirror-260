...
def _stage_main(s):
    ...
    s = re.compile("(?<="+interscript.stdlib.get_alias_re("var-Cyrl", "bel_consonant")+")я", re.MULTILINE).sub("ia", s)
    s = interscript.stdlib.parallel_replace_tree(s, _PTREE_2793600220500053808)
    s = interscript.stdlib.parallel_replace_tree(s, _PTREE_3375725340419199818)
...
_PTREE_2793600220500053808 = {1047:{1068:{None:"Ź"}},1079:{1100:{None:"ź"}},1051:{1068:{None:"Ĺ"}},1083:{1100:{None:"ĺ"}},1057:{1068:{None:"Ś"}},1089:{1100:{None:"ś"}},1062:{1068:{None:"Ć"}},1094:{1100:{None:"ć"}},1053:{1068:{None:"Ń"}},1085:{1100:{None:"ń"}}}
_PTREE_3375725340419199818 = {1030:{None:"I"},1043:{None:"H"},1045:{None:"Je"},1025:{None:"Jo"},1038:{None:"Ŭ"},1061:{None:"Ch"},1068:{None:""},1069:{None:"E"},1070:{None:"Ju"},1071:{None:"Ja"},1075:{None:"h"},1110:{None:"i"},1077:{None:"je"},1105:{None:"jo"},1118:{None:"ŭ"},1093:{None:"ch"},1100:{None:""},1101:{None:"e"},1102:{None:"ju"},1103:{None:"ja"},39:{None:""}}
