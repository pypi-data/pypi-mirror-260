...
class AtomPositionOperator:
    ...
    def search_molecular_subgraph(self, sigma=1.2, id_filter=True, pattern=None, 
                                  prevent_overlapping=True, prevent_shared_nodes:bool=True,
                                  prevent_repeating=True, verbose=False):
        '''
