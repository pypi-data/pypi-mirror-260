...
class AtomPositionOperator:
    ...
    def is_bond(self, n1:int, n2:int, sigma:float=1.2) -> bool:
        return self.distance( self.atomPositions[n1], self.atomPositions[n2]) < (self.covalent_radii[self.atomLabelsList[n1]]+self.covalent_radii[self.atomLabelsList[n2]])*sigma
