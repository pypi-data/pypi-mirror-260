...
def get_matrix_content_from_csv(filename,provided_title="", output_type="examples"):
    matrix = []
...
def get_tex_content_from_csv(filename,provided_title="", output_type="examples"):
    matrix = get_matrix_content_from_csv(filename, provided_title="", output_type="examples")
    return get_tex_content(matrix,provided_title=provided_title,output_type=output_type), matrix
