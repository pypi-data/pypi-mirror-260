...
class Model():
    ...
    def get_flexible_position_from_rigid(self, rigid_position: numpy.ndarray) -> numpy.ndarray: ...
    def get_flexible_velocity_from_rigid(self, rigid_velocity: numpy.ndarray) -> numpy.ndarray: ...
    def get_options(self) -> dict: ...
    def get_rigid_position_from_flexible(self, flexible_position: numpy.ndarray) -> numpy.ndarray: ...
    ...
    def position_limit_upper(self) -> numpy.ndarray:
        ...
        """
    @property
    def rigid_joint_indices(self) -> StdVec_Index:
        """
        :type: StdVec_Index
        """
    @property
