...
def update_floor(viewer: meshcat.Visualizer, geom: Optional[hppfcl.CollisionGeometry] = None) -> None: ...
...
class MeshcatVisualizer(BaseVisualizer):
    ...
    def loadViewerGeometryObject(self, geometry_object: pin.GeometryObject, geometry_type: pin.GeometryType, color: Optional[np.ndarray] = None, material_class: Type[meshcat.geometry.Material] = ...) -> None: ...
