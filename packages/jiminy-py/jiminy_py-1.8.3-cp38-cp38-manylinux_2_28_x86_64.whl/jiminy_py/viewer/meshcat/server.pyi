...
class ZMQWebSocketIpythonBridge(ZMQWebSocketBridge):
    ...
    def __init__(self, zmq_url: Optional[str] = None, comm_url: Optional[str] = None, host: str = '127.0.0.1', port: Optional[int] = None) -> None: ...
    ...
    def send_scene(self, websocket: Optional[WebSocketHandler] = None, comm_id: Optional[bytes] = None) -> None: ...
