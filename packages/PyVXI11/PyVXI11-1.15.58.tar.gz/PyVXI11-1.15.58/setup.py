...
Revision Info:
$Author: noboru $
$Date: 2020-12-01 14:49:19 +0900 $ (isodatesec )
$HGdate: Tue, 01 Dec 2020 14:49:19 +0900 $
$Header: /Users/noboru/src/python/VXI11/PyVXI11-Current/setup.py,v a19a04fdc9c1 2020/12/01 05:49:19 noboru $
$Id: setup.py,v a19a04fdc9c1 2020/12/01 05:49:19 noboru $
$RCSfile: setup.py,v $
$Revision: a19a04fdc9c1 $
...
#
HGTag="$HGTag: 1.15.58-a19a04fdc9c1 $"
HGdate="$HGdate: Tue, 01 Dec 2020 14:49:19 +0900 $" #(rfc822date)
HGlastlog="$lastlog: add comments etc. $"
HGchangelog="$changelog$"
HGcheckedin="$checked in by: Noboru Yamamoto <noboru.yamamoto@kek.jp> $"

#HGTagShort="$HGTagShort: 1.15.58 $"
...
ext_modules.append(Extension("cVXI11", 
                             ...
                             #,cython_cplus=True
                             ,undef_macros=["CFLAGS"]
                             ,extra_compile_args=Extra_Compile_Args # for Linux using tirpc lib.
))
