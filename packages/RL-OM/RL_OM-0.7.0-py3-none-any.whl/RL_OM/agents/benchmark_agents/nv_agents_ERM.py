...
class MLP_block(nn.Module):
    def __init__(self, n_embd_per_head, n_head) -> None:
        super().__init__()
...
class Block(nn.Module):
    def __init__(self, n_embd_per_head, n_head, block_size, dropout) -> None:
        ...
        self.mlp = MLP_block(n_embd_per_head, n_head)
    ...
    def __init__(self,
        ...
        self.transformer = nn.ModuleDict(
            dict(
                ...
                h=nn.ModuleList([Block(n_embd_per_head, n_head, block_size, drop_prob) for _ in range(n_layer)]),
